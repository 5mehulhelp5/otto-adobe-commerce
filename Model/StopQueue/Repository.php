...
class Repository
{
    ...
    /** @var \M2E\Otto\Model\ResourceModel\StopQueue */
    private ResourceModel $stopQueueResource;

    public function __construct(
        \M2E\Otto\Model\ResourceModel\StopQueue $stopQueueResource,
    ...
    public function create(\M2E\Otto\Model\StopQueue $stopQueue): void
    {
        $this->stopQueueResource->save($stopQueue);
    }

    public function save(\M2E\Otto\Model\StopQueue $stopQueue): void
    {
        $this->stopQueueResource->save($stopQueue);
    }
     ...
     * @param int $limit
     *
     * @return \M2E\Otto\Model\StopQueue[]
     */
