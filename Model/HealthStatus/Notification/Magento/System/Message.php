...
namespace M2E\Otto\Model\HealthStatus\Notification\Magento\System;
...
class Message implements MessageInterface
{
    ...
    private \M2E\Otto\Model\HealthStatus\Notification\MessageBuilder $messageBuilder;
    ...
    public function __construct(
        ...
        \M2E\Otto\Model\HealthStatus\Notification\MessageBuilder $messageBuilder,
    ...
    public function getIdentity(): string
    {
        if (
            ...
            return 'Otto-health-status-notification';
        }

        return sha1('Otto-health-status-' . $this->notificationSettings->getLevel());
    }
