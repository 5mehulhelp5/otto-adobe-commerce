...
class Strategy extends \M2E\Otto\Model\AbstractModel
{
    ...
    private ?\M2E\Otto\Model\Lock\Transactional\Manager $initializationLockManager = null;
    private \M2E\Otto\Model\Cron\TaskRepository $taskRepo;
    ...
    public function setParentOperationHistory(\M2E\Otto\Model\Cron\OperationHistory $operationHistory): self
    {
    ...
    private function getLockItemManager(): ?\M2E\Otto\Model\Lock\Item\Manager
    {
        ...
        if (
            $lockItemManager->isInactiveMoreThanSeconds(
                \M2E\Otto\Model\Lock\Item\Manager::DEFAULT_MAX_INACTIVE_TIME
            )
        ) {
    ...
    /**
     * @return \M2E\Otto\Model\Cron\OperationHistory
     */
    ...
    {
        /** @var \M2E\Otto\Model\Lock\Item $lockItem */
