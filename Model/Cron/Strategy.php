...
class Strategy
{
    ...
    public const PROGRESS_START_EVENT_NAME = 'm2e_otto_cron_progress_start';
    public const PROGRESS_SET_PERCENTAGE_EVENT_NAME = 'm2e_otto_cron_progress_set_percentage';
    public const PROGRESS_SET_DETAILS_EVENT_NAME = 'm2e_otto_cron_progress_set_details';
    public const PROGRESS_STOP_EVENT_NAME = 'm2e_otto_cron_progress_stop';
    ...
    private \M2E\Otto\Model\Cron\Strategy\Observer\KeepAlive $observerKeepAlive;
    private \M2E\Otto\Model\Cron\Strategy\Observer\Progress $observerProgress;
    private \M2E\Otto\Model\Lock\Transactional\Manager $initializationLockManager;
    private \M2E\Otto\Model\Cron\TaskCollection $taskCollection;
    private \M2E\Otto\Model\Lock\Item\ManagerFactory $lockItemManagerFactory;
    private \M2E\Otto\Model\Lock\Item\Manager $lockItemManager;
    private OperationHistory $operationHistory;
    private \M2E\Otto\Helper\Module\Exception $exceptionHelper;
    private \M2E\Otto\Model\Lock\Transactional\ManagerFactory $lockTransactionalManagerFactory;
    private \M2E\Otto\Model\Lock\Item\Repository $lockItemRepository;
    /** @var \M2E\Otto\Model\Cron\OperationHistoryFactory */
    private OperationHistoryFactory $operationHistoryFactory;
    /** @var \M2E\Otto\Model\Cron\Manager */
    private Manager $cronManager;
    /** @var \M2E\Otto\Model\Cron\TaskProcessorFactory */
    private TaskProcessorFactory $taskProcessorFactory;

    public function __construct(
        Manager $cronManager,
        \M2E\Otto\Model\Cron\TaskProcessorFactory $taskProcessorFactory,
        \M2E\Otto\Model\Lock\Transactional\ManagerFactory $lockTransactionalManagerFactory,
        \M2E\Otto\Helper\Module\Exception $exceptionHelper,
        \M2E\Otto\Model\Lock\Item\ManagerFactory $lockItemManagerFactory,
        \M2E\Otto\Model\Cron\Strategy\Observer\KeepAlive $observerKeepAlive,
        \M2E\Otto\Model\Cron\Strategy\Observer\Progress $observerProgress,
        \M2E\Otto\Model\Cron\TaskCollection $taskRepo,
        \M2E\Otto\Model\Lock\Item\Repository $lockItemRepository,
    ...
    public function initialize(
        int $initiator,
        \M2E\Otto\Model\Cron\OperationHistory $parentOperationHistory
    ): void {
    ...
    private function getLockItemManager(): \M2E\Otto\Model\Lock\Item\Manager
    {
    ...
    private function getInitializationLockManager(): \M2E\Otto\Model\Lock\Transactional\Manager
    {
        /** @psalm-suppress RedundantPropertyInitializationCheck */
    ...
    private function keepAliveStart(\M2E\Otto\Model\Lock\Item\Manager $lockItemManager): void
    {
    ...
    private function startListenProgressEvents(\M2E\Otto\Model\Lock\Item\Manager $lockItemManager): void
    {
    ...
    private function getOperationHistory(): \M2E\Otto\Model\Cron\OperationHistory
    {
        /** @psalm-suppress RedundantPropertyInitializationCheck */
    ...
    private function makeLockItemShutdownFunction(\M2E\Otto\Model\Lock\Item\Manager $lockItemManager): void
    {
