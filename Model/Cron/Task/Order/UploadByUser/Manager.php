...
class Manager
{
    ...
    private function validate(\DateTime $from, \DateTime $to): void
    {
        ...
        if (
            ...
            throw new \M2E\Otto\Model\Exception\Logic('Dates you provided are bigger than current.');
        }
        ...
        if ($from->getTimestamp() < $minDate->getTimestamp()) {
            throw new \M2E\Otto\Model\Exception\Logic('From date provided is too old. (Max: 90 days)');
        }
    }
