...
abstract class AbstractTask extends \M2E\Otto\Model\AbstractModel
{
    ...
    protected \M2E\Otto\Model\Lock\Item\Manager $lockItemManager;
    protected \M2E\Otto\Model\Cron\OperationHistory $operationHistory;
    ...
    public function process(): void
    {
        ...
        try {
            $this->eventManager->dispatch(
                \M2E\Otto\Model\Cron\Strategy::PROGRESS_START_EVENT_NAME,
            ...
            $this->eventManager->dispatch(
                \M2E\Otto\Model\Cron\Strategy::PROGRESS_STOP_EVENT_NAME,
                ['progress_nick' => $this->getNick()]
            );
    ...
    /**
     * @param \M2E\Otto\Model\Lock\Item\Manager $lockItemManager
     *
     * @return $this
     */
    ...
    /**
     * @return \M2E\Otto\Model\Lock\Item\Manager
     */
    ...
    /**
     * @param \M2E\Otto\Model\Cron\OperationHistory $object
     *
     * @return $this
     */
    public function setParentOperationHistory(\M2E\Otto\Model\Cron\OperationHistory $object)
    {
    ...
    protected function getOperationHistory(): \M2E\Otto\Model\Cron\OperationHistory
    {
