...
class DatabaseRegistry implements \M2E\Core\Model\ControlPanel\Database\RegistryInterface
{
    ...
    {
        return \M2E\Otto\Helper\Module\Database\Tables::getAllTables();
    }

    public function isModuleTable(string $tableName): bool
    {
        return \M2E\Otto\Helper\Module\Database\Tables::isModuleTable($tableName);
    }

    public function getResourceModelClass(string $tableName): string
    {
        return \M2E\Otto\Helper\Module\Database\Tables::getTableResourceModel($tableName);
    }

    public function getModelClass(string $tableName): string
    {
        return \M2E\Otto\Helper\Module\Database\Tables::getTableModel($tableName);
    }
}
