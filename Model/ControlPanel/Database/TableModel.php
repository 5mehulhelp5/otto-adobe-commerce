...
namespace M2E\Otto\Model\ControlPanel\Database;
...
class TableModel
{
    ...
    private function resolveModelNameBySubClass(string $modelName): string
    {
        ...
        if ($reflection->isSubclassOf(\M2E\Otto\Model\ActiveRecord\AbstractModel::class)) {
    ...
    public function createModel(): \M2E\Otto\Model\ActiveRecord\AbstractModel
    {
    ...
    public function updateEntries(array $ids, array $data): void
    {
        ...
        foreach ($collection->getItems() as $item) {
            /** @var \M2E\Otto\Model\ActiveRecord\AbstractModel $item */
