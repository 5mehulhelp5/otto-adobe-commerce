...
use M2E\Otto\Model\ControlPanel\Widget;
...
class OverviewWidgetProvider implements \M2E\Core\Model\ControlPanel\Overview\WidgetProviderInterface
{
    ...
    private \M2E\Otto\Model\Module\Environment $environment;
    /** @var \M2E\Otto\Model\ControlPanel\Widget\CronInfo */
    private Widget\CronInfo $cronInfo;

    public function __construct(
        \M2E\Otto\Helper\Module\Maintenance $maintenance,
        \M2E\Otto\Model\Module\Environment $environment,
        \M2E\Otto\Model\ControlPanel\Widget\CronInfo $cronInfo
    ) {
