...
use M2E\Otto\Helper\Module\Database\Structure as DatabaseStructure;
...
class ConfigsValidity implements InspectorInterface
{
    ...
    private \M2E\Otto\Model\ResourceModel\Config $configResource;
    private \M2E\Otto\Model\Connector\Client\Single $serverClient;

    public function __construct(
        \M2E\Otto\Model\ResourceModel\Config $configResource,
    ...
    {
        $command = new \M2E\Otto\Model\Otto\Connector\System\Config\GetInfoCommand();
