...
HTML
        ...
        if ($this->cronConfig->isRunnerDisabled(\M2E\Otto\Model\Cron\Config::RUNNER_MAGENTO)) {
            $message = sprintf('Cron [%s] is disabled by developer', \M2E\Otto\Model\Cron\Config::RUNNER_MAGENTO);
