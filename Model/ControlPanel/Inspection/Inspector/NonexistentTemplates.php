...
use M2E\Otto\Model\ControlPanel\Inspection\FixerInterface;
...
class NonexistentTemplates implements InspectorInterface, FixerInterface
{
    ...
    private array $_difficultTemplates = [
        [
            'table' => \M2E\Otto\Helper\Module\Database\Tables::TABLE_NAME_TEMPLATE_SELLING_FORMAT,
            'code' => \M2E\Otto\Model\Otto\Template\Manager::TEMPLATE_SELLING_FORMAT,
        ],
        [
            'table' => \M2E\Otto\Helper\Module\Database\Tables::TABLE_NAME_TEMPLATE_SYNCHRONIZATION,
            'code' => \M2E\Otto\Model\Otto\Template\Manager::TEMPLATE_SYNCHRONIZATION,
        ],
        [
            'table' => \M2E\Otto\Helper\Module\Database\Tables::TABLE_NAME_TEMPLATE_DESCRIPTION,
            'code' => \M2E\Otto\Model\Otto\Template\Manager::TEMPLATE_DESCRIPTION,
        ],
            ...
            foreach ($items as $index => $itemInfo) {
                ...
                if (!isset($itemInfo['my_mode']) && !isset($itemInfo['parent_mode'])) {
                    ...
                    $url = $this->urlBuilder->getUrl(
                        'Otto/controlPanel_module_integration/otto',
                        $params
                    );
...
HTML;
                ...
                if (isset($itemInfo['my_mode']) && $itemInfo['my_mode'] == 1) {
                    ...
                    $url = $this->urlBuilder->getUrl(
                        'Otto/controlPanel_module_integration_otto/repairNonexistentTemplates',
                        $params
                    );
        ...
        if ($data['action'] === self::FIX_ACTION_SET_PARENT) {
            ...
            foreach ($collection->getItems() as $listingProduct) {
                $listingProduct->setData(
                    ...
                    \M2E\Otto\Model\Otto\Template\Manager::MODE_PARENT
                );
