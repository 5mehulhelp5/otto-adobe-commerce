...
namespace M2E\Otto\Model\ControlPanel\Inspection\Repository;
...
class DefinitionProvider
{
    ...
    private array $inspectionsData = [
        [
            ...
            'handler' => \M2E\Otto\Model\ControlPanel\Inspection\Inspector\ExtensionCron::class,
        ],
        [
            ...
            'handler' => \M2E\Otto\Model\ControlPanel\Inspection\Inspector\FilesPermissions::class,
        ],
        [
            ...
            'group' => self::GROUP_STRUCTURE,
            'execution_speed_group' => self::EXECUTION_SPEED_FAST,
            'handler' => \M2E\Otto\Model\ControlPanel\Inspection\Inspector\MagentoSettings::class,
        ],
        [
            ...
            'execution_speed_group' => self::EXECUTION_SPEED_FAST,
            'handler' => \M2E\Otto\Model\ControlPanel\Inspection\Inspector\NonexistentTemplates::class,
        ],
        [
            ...
            'group' => self::GROUP_GENERAL,
            'execution_speed_group' => self::EXECUTION_SPEED_FAST,
            'handler' => \M2E\Otto\Model\ControlPanel\Inspection\Inspector\ServerConnection::class,
        ],
        [
            'nick' => 'ShowOttoLoggers',
            'title' => 'Show Otto loggers',
            'description' => '',
            'group' => self::GROUP_STRUCTURE,
            'execution_speed_group' => self::EXECUTION_SPEED_SLOW,
            'handler' => \M2E\Otto\Model\ControlPanel\Inspection\Inspector\ShowModuleLoggers::class,
        ],
        [
            ...
            'group' => self::GROUP_STRUCTURE,
            'execution_speed_group' => self::EXECUTION_SPEED_FAST,
            'handler' => \M2E\Otto\Model\ControlPanel\Inspection\Inspector\ConfigsValidity::class,
        ],
        [
            'nick' => 'FilesValidity',
            ...
            'group' => self::GROUP_STRUCTURE,
            'execution_speed_group' => self::EXECUTION_SPEED_FAST,
            'handler' => \M2E\Otto\Model\ControlPanel\Inspection\Inspector\FilesValidity::class,
        ],
        [
            ...
            'group' => self::GROUP_STRUCTURE,
            'execution_speed_group' => self::EXECUTION_SPEED_FAST,
            'handler' => \M2E\Otto\Model\ControlPanel\Inspection\Inspector\TablesStructureValidity::class,
        ],
    ];

    private \M2E\Otto\Model\ControlPanel\Inspection\DefinitionFactory $definitionFactory;

    public function __construct(
        \M2E\Otto\Model\ControlPanel\Inspection\DefinitionFactory $definitionFactory
    ) {
