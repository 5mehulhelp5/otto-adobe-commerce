...
namespace M2E\Otto\Model\MSI\Order;
...
class Reserve
{
    public const EVENT_TYPE_MAGENTO_RESERVATION_PLACED = 'otto_reservation_placed';
    public const EVENT_TYPE_MAGENTO_RESERVATION_RELEASED = 'otto_reservation_released';

    public const M2E_ORDER_OBJECT_TYPE = 'otto_order';
