...
class DeleteService
{
    private \M2E\Otto\Model\Processing\Repository $processingRepository;
    private \M2E\Otto\Model\Processing\Lock\Repository $processingLockRepository;

    public function __construct(
        \M2E\Otto\Model\Processing\Repository $processingRepository,
        \M2E\Otto\Model\Processing\Lock\Repository $processingLockRepository
    ) {
