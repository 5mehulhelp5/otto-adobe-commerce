...
namespace M2E\Otto\Model\Synchronization;
...
class LogService
{
    ...
    private int $initiator = \M2E\Otto\Helper\Data::INITIATOR_UNKNOWN;
    private int $task = \M2E\Otto\Model\Synchronization\Log::TASK_OTHER;
