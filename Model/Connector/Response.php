...
class Response
{
    ...
    {
        return $this->resultType === \M2E\Otto\Model\Response\Message::TYPE_SUCCESS;
    }

    public function isResultError(): bool
    {
        return $this->resultType === \M2E\Otto\Model\Response\Message::TYPE_ERROR;
    }

    public function isResultWarning(): bool
    {
        return $this->resultType === \M2E\Otto\Model\Response\Message::TYPE_WARNING;
    }

    public function isResultNotice(): bool
    {
        return $this->resultType === \M2E\Otto\Model\Response\Message::TYPE_NOTICE;
    }
