...
use M2E\Otto\Model\ResourceModel\Listing\Log as LogResource;

/**
 * @method \M2E\Otto\Model\ResourceModel\Listing\Log getResource()
 */

/**
 * @method \M2E\Otto\Model\ResourceModel\Listing\Log\Collection getCollection()
 */
class Log extends \M2E\Otto\Model\Log\AbstractModel
{
    ...
    {
        parent::_construct();
        $this->_init(\M2E\Otto\Model\ResourceModel\Listing\Log::class);
    }
    ...
    {
        return (int)$this->getData(\M2E\Otto\Model\ResourceModel\Listing\Log::COLUMN_ACCOUNT_ID);
    }

    public function getListingId(): int
    {
        return (int)$this->getData(\M2E\Otto\Model\ResourceModel\Listing\Log::COLUMN_LISTING_ID);
    }

    public function getListingProductId(): ?int
    {
        $value = $this->getData(\M2E\Otto\Model\ResourceModel\Listing\Log::COLUMN_LISTING_PRODUCT_ID);
        if (empty($value)) {
            return null;
        }
    ...
    {
        return (int)$this->getData(\M2E\Otto\Model\ResourceModel\Listing\Log::COLUMN_ACTION_ID);
    }

    public function getType(): int
    {
        return (int)$this->getData(\M2E\Otto\Model\ResourceModel\Listing\Log::COLUMN_TYPE);
    }
