...
class Manager
{
    ...
    /** @var \M2E\Otto\Model\Listing\Wizard\StepDeclarationCollection */
    private StepDeclarationCollection $stepCollection;
    private \M2E\Otto\Model\Listing\Wizard\ProductFactory $productFactory;
    /** @var \M2E\Otto\Model\Listing\Wizard\Step\BackHandlerFactory */
    private Step\BackHandlerFactory $stepBackHandlerFactory;

    public function __construct(
        \M2E\Otto\Model\Listing\Wizard $wizard,
        \M2E\Otto\Model\Listing\Wizard\StepDeclarationCollection $stepCollection,
        \M2E\Otto\Model\Listing\Wizard\ProductFactory $productFactory,
        \M2E\Otto\Model\Listing\Wizard\Step\BackHandlerFactory $stepBackHandlerFactory,
    ...
    {
        return $this->getWizardType() === \M2E\Otto\Model\Listing\Wizard::TYPE_GENERAL;
    }

    public function isWizardTypeUnmanaged(): bool
    {
        return $this->getWizardType() === \M2E\Otto\Model\Listing\Wizard::TYPE_UNMANAGED;
    }
    ...
    /**
     * @param \M2E\Otto\Model\Listing\Other $unmanagedProduct
     *
     * @return void
     */
    public function addUnmanagedProduct(\M2E\Otto\Model\Listing\Other $unmanagedProduct): ?\M2E\Otto\Model\Listing\Wizard\Product
    {
     ...
     */
    public function findProductByMagentoId(int $magentoProductId): ?\M2E\Otto\Model\Listing\Wizard\Product
    {
     ...
     * @return \M2E\Otto\Model\Listing\Wizard\Product|null
     */
    public function findProductById(int $id): ?\M2E\Otto\Model\Listing\Wizard\Product
    {
