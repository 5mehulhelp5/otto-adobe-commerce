...
class Create
{
    ...
    /** @var \M2E\Otto\Model\Listing\Wizard\StepFactory */
    private StepFactory $stepFactory;
    /** @var \M2E\Otto\Model\Listing\Wizard\StepDeclarationCollectionFactory */
    private StepDeclarationCollectionFactory $stepDeclarationCollectionFactory;
    /** @var \M2E\Otto\Model\Listing\Wizard\DeleteService */
    private DeleteService $deleteService;

    public function __construct(
        Repository $wizardRepository,
        \M2E\Otto\Model\Listing\WizardFactory $wizardFactory,
        \M2E\Otto\Model\Listing\Wizard\StepFactory $stepFactory,
        StepDeclarationCollectionFactory $stepDeclarationCollectionFactory,
        \M2E\Otto\Model\Listing\Wizard\DeleteService $deleteService
    ) {
    ...
    public function process(\M2E\Otto\Model\Listing $listing, string $type): \M2E\Otto\Model\Listing\Wizard
    {
        \M2E\Otto\Model\Listing\Wizard::validateType($type);
