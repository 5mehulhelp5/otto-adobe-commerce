...
class Repository
{
    ...
    private \M2E\Otto\Model\ResourceModel\Listing\Wizard\Step $stepResource;
    private \M2E\Otto\Model\ResourceModel\Listing\Wizard\Step\CollectionFactory $stepCollectionFactory;
    private \M2E\Otto\Model\Listing\WizardFactory $wizardFactory;
    private \M2E\Otto\Model\ResourceModel\Listing\Wizard\CollectionFactory $wizardCollectionFactory;
    private WizardProductResource $wizardProductResource;
    private \M2E\Otto\Model\Listing\Wizard\ProductCollectionFactory $productCollectionFactory;
    private \M2E\Otto\Model\ResourceModel\Listing\Wizard\Product\CollectionFactory $wizardProductCollectionFactory;

    public function __construct(
        \M2E\Otto\Model\Listing\WizardFactory $wizardFactory,
        WizardResource $wizardResource,
        \M2E\Otto\Model\ResourceModel\Listing\Wizard\CollectionFactory $wizardCollectionFactory,
        \M2E\Otto\Model\ResourceModel\Listing\Wizard\Step $stepResource,
        \M2E\Otto\Model\ResourceModel\Listing\Wizard\Step\CollectionFactory $stepCollectionFactory,
        WizardProductResource $wizardProductResource,
        \M2E\Otto\Model\ResourceModel\Listing\Wizard\Product\CollectionFactory $wizardProductCollectionFactory,
        \M2E\Otto\Model\Listing\Wizard\ProductCollectionFactory $productCollectionFactory
    ) {
    ...
    /**
     * @param \M2E\Otto\Model\Listing\Wizard $wizard
     *
     * @return void
     */
    public function create(\M2E\Otto\Model\Listing\Wizard $wizard): void
    {
        $this->wizardResource->save($wizard);
    }

    /**
     * @param \M2E\Otto\Model\Listing\Wizard\Step[] $steps
     *
     * @return void
     */
     ...
     * @return void
     */
    public function save(\M2E\Otto\Model\Listing\Wizard $wizard): void
    {
        $this->wizardResource->save($wizard);
    }

    /**
     * @param \M2E\Otto\Model\Listing\Wizard\Step $step
     *
     * @return void
     */
    ...
    /**
     * @param \M2E\Otto\Model\Listing\Wizard\Product $product
     *
     * @return void
     */
     ...
     * @return void
     */
    public function remove(\M2E\Otto\Model\Listing\Wizard $wizard): void
    {
     ...
     * @param int $id
     *
     * @return \M2E\Otto\Model\Listing\Wizard
     */
    public function get(int $id): \M2E\Otto\Model\Listing\Wizard
    {
        $wizard = $this->find($id);
        if ($wizard === null) {
            throw new \M2E\Otto\Model\Listing\Wizard\Exception\NotFoundException('Wizard not found.');
        }
     ...
     * @param int $id
     *
     * @return \M2E\Otto\Model\Listing\Wizard|null
     */
    public function find(int $id): ?\M2E\Otto\Model\Listing\Wizard
    {
    ...
    /**
     * @param \M2E\Otto\Model\Listing $listing
     * @param string $type
     *
     * @return \M2E\Otto\Model\Listing\Wizard|null
     */
    public function findNotCompletedByListingAndType(
        ...
        string $type
    ): ?\M2E\Otto\Model\Listing\Wizard {
        $collection = $this->wizardCollectionFactory->create();
        $collection
            ->addFieldToFilter(\M2E\Otto\Model\ResourceModel\Listing\Wizard::COLUMN_LISTING_ID, ['eq' => $listing->getId()])
            ->addFieldToFilter(\M2E\Otto\Model\ResourceModel\Listing\Wizard::COLUMN_IS_COMPLETED, ['eq' => 0])
            ->addFieldToFilter(\M2E\Otto\Model\ResourceModel\Listing\Wizard::COLUMN_TYPE, ['eq' => $type]);
     ...
     * @return \M2E\Otto\Model\Listing\Wizard|null
     */
    public function findNotCompletedWizardByType(string $type): ?\M2E\Otto\Model\Listing\Wizard
    {
        $collection = $this->wizardCollectionFactory->create();
        $collection
            ->addFieldToFilter(\M2E\Otto\Model\ResourceModel\Listing\Wizard::COLUMN_IS_COMPLETED, ['eq' => 0])
     ...
     * @param \M2E\Otto\Model\Listing\Wizard $wizard
     *
     * @return \M2E\Otto\Model\Listing\Wizard\Step[]
     */
    public function findSteps(\M2E\Otto\Model\Listing\Wizard $wizard): array
    {
        $stepCollection = $this->stepCollectionFactory->create();
        $stepCollection->addFieldToFilter(
            \M2E\Otto\Model\ResourceModel\Listing\Wizard\Step::COLUMN_WIZARD_ID,
            $wizard->getId(),
        );
     ...
     * @return void
     */
    private function loadSteps(\M2E\Otto\Model\Listing\Wizard $wizard): void
    {
     ...
     * @param \M2E\Otto\Model\Listing\Wizard $wizard
     *
     * @return \M2E\Otto\Model\Listing\Wizard\Product[]
     */
    public function findAllProducts(\M2E\Otto\Model\Listing\Wizard $wizard): array
    {
        $productCollection = $this->productCollectionFactory->create();
        $productCollection->addFieldToFilter(
            \M2E\Otto\Model\ResourceModel\Listing\Wizard\Product::COLUMN_WIZARD_ID,
            $wizard->getId(),
        );
     ...
     * @return \M2E\Otto\Model\Listing\Wizard\Product[]
     */
    public function findNotProcessed(\M2E\Otto\Model\Listing\Wizard $wizard): array
    {
     ...
     * @return int
     */
    public function getProcessedProductsCount(\M2E\Otto\Model\Listing\Wizard $wizard): int
    {
     ...
     * @return void
     */
    public function removeAllProducts(\M2E\Otto\Model\Listing\Wizard $wizard): void
    {
     ...
     * @param \M2E\Otto\Model\Listing\Wizard $wizard
     *
     * @return \M2E\Otto\Model\Listing\Wizard\Product|null
     */
    public function findProductById(
        int $id,
        \M2E\Otto\Model\Listing\Wizard $wizard
    ): ?\M2E\Otto\Model\Listing\Wizard\Product {
        $productCollection = $this->productCollectionFactory->create();
        $productCollection
            ->addFieldToFilter(\M2E\Otto\Model\ResourceModel\Listing\Wizard\Product::COLUMN_WIZARD_ID, $wizard->getId())
            ->addFieldToFilter(\M2E\Otto\Model\ResourceModel\Listing\Wizard\Product::COLUMN_ID, ['eq' => $id]);
    ...
    public function findProductByMagentoId(
        ...
        $productCollection
            ->addFieldToFilter(\M2E\Otto\Model\ResourceModel\Listing\Wizard\Product::COLUMN_WIZARD_ID, $wizard->getId())
            ->addFieldToFilter(\M2E\Otto\Model\ResourceModel\Listing\Wizard\Product::COLUMN_MAGENTO_PRODUCT_ID, ['eq' => $id]);
     ...
     * @return \M2E\Otto\Model\Listing\Wizard[]
     */
    public function findWizardsByListing(\M2E\Otto\Model\Listing $listing): array
    {
        $collection = $this->wizardCollectionFactory->create();
        $collection
    ...
    /**
     * @param \M2E\Otto\Model\Listing\Wizard\Product[] $wizardProducts
     *
     * @return void
     */
    public function addOrUpdateProducts(array $wizardProducts): void
    {
        ...
        foreach (array_chunk($wizardProducts, 500) as $productsChunk) {
            $preparedData = [];
            /** @var \M2E\Otto\Model\Listing\Wizard\Product $product */
