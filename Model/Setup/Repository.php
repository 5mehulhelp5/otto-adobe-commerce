...
use M2E\Otto\Model\ResourceModel\Setup as SetupResource;
use Magento\Framework\DB\Ddl\Table;

class Repository
{
    private \M2E\Otto\Model\ResourceModel\Setup $setupResource;
    private \M2E\Otto\Model\ResourceModel\Setup\CollectionFactory $collectionFactory;
    private \M2E\Otto\Helper\Module\Database\Structure $dbHelper;

    public function __construct(
        \M2E\Otto\Model\ResourceModel\Setup $setupResource,
        \M2E\Otto\Model\ResourceModel\Setup\CollectionFactory $collectionFactory,
        \M2E\Otto\Helper\Module\Database\Structure $dbHelper
    ) {
    ...
    public function create(?string $fromVersion, string $toVersion): \M2E\Otto\Model\Setup
    {
    ...
    public function save(\M2E\Otto\Model\Setup $setup): void
    {
        if (!$this->isSetupTableExists()) {
            return;
        }
    ...
    public function findLastExecuted(): ?\M2E\Otto\Model\Setup
    {
        if (!$this->isSetupTableExists()) {
            return null;
        }
        ...
        /** @var \M2E\Otto\Model\Setup $maxCompletedItem */
    ...
    public function findLastUpgrade(): ?\M2E\Otto\Model\Setup
    {
        if (!$this->isSetupTableExists()) {
            return null;
        }
    ...
    public function createTable(): void
    {
        ...
        $tableName = $this->dbHelper->getTableNameWithPrefix(
            \M2E\Otto\Helper\Module\Database\Tables::TABLE_NAME_SETUP,
        );
    ...
    {
        return $this->dbHelper->isTableExists(\M2E\Otto\Helper\Module\Database\Tables::TABLE_NAME_SETUP, true);
    }
}
