...
namespace M2E\Otto\Model\ResourceModel\Tag\ListingProduct;

class Relation extends \M2E\Otto\Model\ResourceModel\ActiveRecord\AbstractModel
{
    ...
    {
        $this->_init(
            \M2E\Otto\Helper\Module\Database\Tables::TABLE_NAME_PRODUCT_TAG_RELATION,
            self::COLUMN_ID
        );
    }
