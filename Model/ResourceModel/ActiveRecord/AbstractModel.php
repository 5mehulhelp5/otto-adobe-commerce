...
use M2E\Otto\Model\ActiveRecord\AbstractModel as ActiveRecordAbstract;
...
abstract class AbstractModel extends \Magento\Framework\Model\ResourceModel\Db\AbstractDb
{
    ...
    protected function _beforeSave(\Magento\Framework\Model\AbstractModel $object)
    {
        ...
        if ($object->isObjectNew()) {
            $object->setData('create_date', \M2E\Otto\Helper\Date::createCurrentGmt()->format('Y-m-d H:i:s'));
        }

        $object->setData('update_date', \M2E\Otto\Helper\Date::createCurrentGmt()->format('Y-m-d H:i:s'));
