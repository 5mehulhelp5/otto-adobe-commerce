...
class Wizard extends \M2E\Otto\Model\ResourceModel\ActiveRecord\AbstractModel
{
    ...
    {
        $this->_init(\M2E\Otto\Helper\Module\Database\Tables::TABLE_NAME_LISTING_WIZARD, self::COLUMN_ID);
    }
}
