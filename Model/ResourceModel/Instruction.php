...
class Instruction extends \M2E\Otto\Model\ResourceModel\ActiveRecord\AbstractModel
{
    ...
    {
        $this->_init(\M2E\Otto\Helper\Module\Database\Tables::TABLE_NAME_PRODUCT_INSTRUCTION, 'id');
    }
}
