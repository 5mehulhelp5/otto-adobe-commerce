...
class TemplateParser
{
    ...
    public function parseTemplate($text, \M2E\Otto\Model\Magento\Product $magentoProduct): string
    {
    ...
    private function insertAttributes($text, \M2E\Otto\Model\Magento\Product $magentoProduct): string
    {
