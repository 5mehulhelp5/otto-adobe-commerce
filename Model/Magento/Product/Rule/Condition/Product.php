...
namespace M2E\Otto\Model\Magento\Product\Rule\Condition;
...
class Product extends AbstractModel
{
    ...
    public function getValueElementRenderer()
    {
        ...
        return $this->_layout->getBlockSingleton(
            \M2E\Otto\Block\Adminhtml\Magento\Product\Rule\Renderer\Editable::class
        );
    }
    ...
    public function getValueAfterElementHtml()
    {
        ...
        switch ($this->getAttribute()) {
            case 'sku':
            case 'category_ids':
                $image = $this->_assetRepo->getUrl('M2E_Otto::images/rule_chooser_trigger.gif');
                break;
        }
