...
namespace M2E\Otto\Model\Magento\Product\Variation;

class Cache extends \M2E\Otto\Model\Magento\Product\Variation
{
    ...
    protected function getMethodData($methodName, $params = null)
    {
        if ($this->getMagentoProduct() === null) {
            throw new \M2E\Otto\Model\Exception('Magento Product was not set.');
        }
