...
use M2E\Otto\Model\Magento\Product\Image;
use M2E\Otto\Model\Magento\Product\Inventory\Factory;
...
class Product
{
    ...
    /** @var \M2E\Otto\Model\Magento\Product\Variation */
    ...
    protected $isGroupedProductMode = \M2E\Otto\Model\Product::GROUPED_PRODUCT_MODE_OPTIONS;
    ...
    /** @var \M2E\Otto\Model\Magento\Product\ImageFactory */
    private Product\ImageFactory $imageFactory;
    /** @var \M2E\Otto\Model\Magento\Product\VariationFactory */
     ...
     *
     * @return \M2E\Otto\Model\Magento\Product | \M2E\Otto\Model\Magento\Product\Cache
    ...
    public function loadProduct($productId = null, $storeId = null)
    {
        ...
        if ($productId <= 0) {
            throw new \M2E\Otto\Model\Exception('The Product ID is not set.');
        }
     ...
     * @param int $productId
     *
     * @return \M2E\Otto\Model\Magento\Product
     */
    ...
    public function getProduct(): \Magento\Catalog\Model\Product
    {
        ...
        throw new \M2E\Otto\Model\Exception('Load instance first');
    }
    ...
    {
        if (\M2E\Otto\Model\Product::GROUPED_PRODUCT_MODE_SET == $this->isGroupedProductMode) {
    ...
    protected function getGroupedQty($lifeMode = false)
    {
        ...
        foreach ($this->getTypeInstance()->getAssociatedProducts($this->getProduct()) as $childProduct) {
            ...
            if (\M2E\Otto\Model\Product::GROUPED_PRODUCT_MODE_OPTIONS == $this->isGroupedProductMode) {
                $value += $qty;
                continue;
            }
    ...
    public function getVariationInstance()
    {
        if ($this->_variationInstance === null) {
            $this->_variationInstance = $this->variationFactory->create()
