...
namespace M2E\Otto\Model\Magento\Quote\Total;

use M2E\Otto\Model\Magento\Tax\Rule\Builder as TaxRuleBuilder;
...
class RoundTaxPercent extends \Magento\Quote\Model\Quote\Address\Total\AbstractTotal
{
    ...
    public function collect(
        ...
        /** @var \M2E\Otto\Model\Order\Tax\PriceTaxRateInterface $productPriceTaxRate */
        ...
        /** @var \M2E\Otto\Model\Order\Tax\PriceTaxRateInterface $shippingPriceTaxRate */
    ...
    private function processForPriceTax(
        string $ruleCode,
        \Magento\Quote\Model\Quote\Address\Total $total,
        \M2E\Otto\Model\Order\Tax\PriceTaxRateInterface $taxRate
    ): void {
     ...
     * @param \M2E\Otto\Model\Order\Tax\PriceTaxRateInterface $taxRate
     *
     * @return float|int
     */
    private function replaceTaxPercent($inputPercent, \M2E\Otto\Model\Order\Tax\PriceTaxRateInterface $taxRate)
    {
