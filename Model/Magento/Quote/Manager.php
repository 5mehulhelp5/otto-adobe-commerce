...
class Manager
{
    ...
    /** @var \M2E\Otto\Model\Magento\Backend\Model\Session\Quote */
    ...
    public function __construct(
        ...
        \M2E\Otto\Model\Magento\Backend\Model\Session\Quote $sessionQuote,
    ...
    public function submit(\Magento\Quote\Model\Quote $quote)
    {
        try {
            ...
            if ($order !== null && $order->getId()) {
                ...
                throw new \M2E\Otto\Model\Magento\Quote\FailDuringEventProcessing(
                    $order,
