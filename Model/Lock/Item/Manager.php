...
class Manager
{
    ...
    private string $nick;
    private \M2E\Otto\Model\ResourceModel\Lock\Item\CollectionFactory $lockItemCollectionFactory;
    private \M2E\Otto\Model\Lock\ItemFactory $lockItemFactory;
    private ManagerFactory $lockItemManagerFactory;

    public function __construct(
        \M2E\Otto\Model\Lock\Item\ManagerFactory $lockItemManagerFactory,
        \M2E\Otto\Model\Lock\ItemFactory $lockItemFactory,
        \M2E\Otto\Model\ResourceModel\Lock\Item\CollectionFactory $lockItemCollectionFactory,
        string $nick
    ) {
    ...
    public function remove(): bool
    {
        ...
        /** @var \M2E\Otto\Model\Lock\Item[] $childLockItems */
    ...
    private function getLockItemObject(): ?\M2E\Otto\Model\Lock\Item
    {
