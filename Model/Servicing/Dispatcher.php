...
namespace M2E\Otto\Model\Servicing;
...
class Dispatcher
{
    ...
    private \M2E\Otto\Model\Registry\Manager $registryManager;
    private \Magento\Framework\ObjectManagerInterface $objectManager;
    private \M2E\Otto\Model\Connector\Client\Single $serverConnector;

    public function __construct(
        \M2E\Otto\Helper\Module\Exception $helperException,
        \M2E\Otto\Model\Registry\Manager $registryManager,
        \Magento\Framework\ObjectManagerInterface $objectManager,
        \M2E\Otto\Model\Connector\Client\Single $serverConnector
    ) {
    ...
    private function processTasks(array $taskCodes): void
    {
        ...
        $command = new \M2E\Otto\Model\Connector\Command\ServicingCommand($requestData);
     ...
     *
     * @return \M2E\Otto\Model\Servicing\TaskInterface[]
     */
    ...
    private function getTaskModel(string $taskName): TaskInterface
    {
        ...
        /** @var \M2E\Otto\Model\Servicing\TaskInterface */
