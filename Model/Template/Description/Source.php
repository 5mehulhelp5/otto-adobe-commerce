...
class Source
{
    ...
    private ?\M2E\Otto\Model\Magento\Product\Image\Set $imagesSet = null;
    ...
    private \M2E\Otto\Model\Magento\Product\ImageFactory $magentoProductImageFactory;
    ...
    public function __construct(
        ...
        \M2E\Otto\Model\Magento\Product\ImageFactory $magentoProductImageFactory
    ) {
    ...
    public function setDescriptionTemplate(\M2E\Otto\Model\Template\Description $instance): self
    {
    ...
    /**
     * @throws \M2E\Otto\Model\Exception|\Magento\Framework\Exception\FileSystemException
     */
    ...
    public function getImageSet(): \M2E\Otto\Model\Magento\Product\Image\Set
    {
        ...
        $set = new \M2E\Otto\Model\Magento\Product\Image\Set();
    ...
    public function getMainImage(): ?\M2E\Otto\Model\Magento\Product\Image
    {
        $image = null;
    ...
    public function getBulletPoints(): array
    {
        ...
        $bulletPointsSource = $this->getDescriptionTemplate()->getBulletPoints();
        foreach ($bulletPointsSource as $source) {
            $bulletPoints[] = $this->getMagentoProduct()->getAttributeValue($source);
        }
