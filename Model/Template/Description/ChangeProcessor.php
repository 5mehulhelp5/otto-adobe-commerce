...
class ChangeProcessor extends \M2E\Otto\Model\Template\ChangeProcessorAbstract
{
    ...
    /**
     * @param \M2E\Otto\Model\Template\Description\Diff $diff
     */
    protected function getInstructionsData(
        \M2E\Otto\Model\ActiveRecord\Diff $diff,
        int $status
    ): array {
        /** @var \M2E\Otto\Model\Template\Description\Diff $diff */
        ...
        if ($diff->isTitleDifferent()) {
            ...
            $data[] = [
                'type' => \M2E\Otto\Model\Template\ChangeProcessorAbstract::INSTRUCTION_TYPE_TITLE_DATA_CHANGED,
                'priority' => $priority,
            ];
        }
        ...
        if ($diff->isDescriptionDifferent()) {
            ...
            $data[] = [
                'type' => \M2E\Otto\Model\Template\ChangeProcessorAbstract::INSTRUCTION_TYPE_DESCRIPTION_DATA_CHANGED,
                'priority' => $priority,
            ];
        }
        ...
        if ($diff->isImagesDifferent()) {
            ...
            $data[] = [
                'type' => \M2E\Otto\Model\Template\ChangeProcessorAbstract::INSTRUCTION_TYPE_IMAGES_DATA_CHANGED,
                'priority' => $priority,
            ];
        }
