...
class Description extends \M2E\Otto\Model\ActiveRecord\AbstractModel implements PolicyInterface
{
    ...
    /** @var \M2E\Otto\Model\Template\Description\Source[] */
    ...
    {
        parent::_construct();
        $this->_init(\M2E\Otto\Model\ResourceModel\Template\Description::class);
    }
     ...
     *
     * @return \M2E\Otto\Model\Template\Description\Source
     */
    ...
    {
        $bulletPoints = $this->getData(DescriptionResource::COLUMN_BULLET_POINTS);
        if (empty($bulletPoints)) {
            return [];
        }

        return json_decode($bulletPoints, true);
    }
}
