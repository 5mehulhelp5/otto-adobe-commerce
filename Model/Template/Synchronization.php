...
class Synchronization extends \M2E\Otto\Model\ActiveRecord\AbstractModel implements PolicyInterface
{
    ...
    {
        parent::_construct();
        $this->_init(\M2E\Otto\Model\ResourceModel\Template\Synchronization::class);
    }
