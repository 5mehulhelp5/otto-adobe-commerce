...
{
    private ?\M2E\Otto\Model\ActiveRecord\AbstractModel $model = null;

    abstract public function loadListingProductCollection(
        array $filters = []
    ): \M2E\Otto\Model\ResourceModel\Product\Collection;

    public function setModel(\M2E\Otto\Model\ActiveRecord\AbstractModel $model): self
    {
        $this->model = $model;
    ...
    public function getModel(): ?\M2E\Otto\Model\ActiveRecord\AbstractModel
    {
        return $this->model;
    }
