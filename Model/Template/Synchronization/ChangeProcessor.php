...
class ChangeProcessor extends \M2E\Otto\Model\Template\Synchronization\ChangeProcessorAbstract
{
    ...
    /**
     * @param \M2E\Otto\Model\Template\Synchronization\Diff $diff
     */
    protected function getInstructionsData(
        ...
        if ($diff->isReviseQtyEnabled()) {
            $data[] = [
                ...
                'priority' => $status === \M2E\Otto\Model\Product::STATUS_LISTED ? 80 : 5,
            ];
        ...
        if ($diff->isRevisePriceEnabled()) {
            $data[] = [
                ...
                'priority' => $status === \M2E\Otto\Model\Product::STATUS_LISTED ? 60 : 5,
            ];
