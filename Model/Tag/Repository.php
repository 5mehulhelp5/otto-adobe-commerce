...
class Repository
{
    ...
    /** @var \M2E\Otto\Model\Tag\EntityFactory */
    private $entityFactory;

    private $isLoad = false;
    private $entitiesByErrorCode = [];
    private $entitiesById = [];
    /** @var \M2E\Otto\Model\Tag[] */
    private $tags;

    public function __construct(
        \M2E\Otto\Model\TagFactory $tagFactory,
        \M2E\Otto\Model\ResourceModel\Tag\CollectionFactory $collectionFactory,
    ...
    public function create(\M2E\Otto\Model\Tag $tag): void
    {
        if ($this->has($tag)) {
            return;
        }
    ...
    public function has(\M2E\Otto\Model\Tag $tag): bool
    {
        $this->load();
    ...
    public function findEntityById(int $id): ?\M2E\Otto\Model\Tag\Entity
    {
        $this->load();
