...
use M2E\Otto\Model\ResourceModel;
...
class Buffer
{
    ...
    private \M2E\Otto\Model\Tag\Repository $tagRepository;
    private Repository $listingProductTagRepository;
    private \M2E\Otto\Model\Product\Repository $productRepository;
    private \M2E\Otto\Model\Tag\BlockingErrors $blockingErrors;

    public function __construct(
        \M2E\Otto\Model\Tag\Repository $tagRepository,
        ResourceModel\Tag\ListingProduct\Relation $relationResource,
        \M2E\Otto\Model\Tag\ListingProduct\Repository $listingProductTagRepository,
        \M2E\Otto\Model\Product\Repository $productRepository,
        \M2E\Otto\Model\Tag\BlockingErrors $blockingErrors
    ) {
    ...
    public function addTag(\M2E\Otto\Model\Product $listingProduct, \M2E\Otto\Model\Tag $tag): void
    {
     ...
     * @param \M2E\Otto\Model\Tag[] $tags
     *
     * @return void
     */
    public function addTags(\M2E\Otto\Model\Product $listingProduct, array $tags): void
    {
    ...
    public function removeAllTags(\M2E\Otto\Model\Product $listingProduct): void
    {
        $item = $this->getItem((int)$listingProduct->getId());
    ...
    /**
     * @return array<string, \M2E\Otto\Model\Tag\Entity>
     */
     ...
     * @param Buffer\Item[] $items
     *
     * @return array<int, <string, \M2E\Otto\Model\Tag\Entity>>
     */
    ...
    /**
     * @param \M2E\Otto\Model\Tag\ListingProduct\Buffer\Item[] $items
    ...
    private function flushAdd(array $items, array $tagsEntitiesByErrorCode, array $existsRelations): void
    {
        ...
        if (!empty($productIdsWithBlockingError)) {
            $lastBlockingErrorDate = \M2E\Otto\Helper\Date::createCurrentGmt();
