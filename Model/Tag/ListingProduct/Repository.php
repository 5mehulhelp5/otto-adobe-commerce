...
class Repository
{
    private \M2E\Otto\Model\ResourceModel\Tag $tagResource;
    private \M2E\Otto\Model\Product\Repository $productRepository;
    /** @var \M2E\Otto\Model\ResourceModel\Tag\ListingProduct\Relation\CollectionFactory */
    private $relationCollectionFactory;
    /** @var \M2E\Otto\Model\ResourceModel\Tag\CollectionFactory */
    private $tagCollectionFactory;
    /** @var \M2E\Otto\Model\ResourceModel\Tag\ListingProduct\Relation */
    private $relationResource;
    /** @var \M2E\Otto\Model\ResourceModel\Product */
    private $listingProductResource;

    public function __construct(
        \M2E\Otto\Model\ResourceModel\Tag\ListingProduct\Relation\CollectionFactory $relationCollectionFactory,
        \M2E\Otto\Model\ResourceModel\Tag\CollectionFactory $tagCollectionFactory,
        \M2E\Otto\Model\ResourceModel\Tag\ListingProduct\Relation $relationResource,
        \M2E\Otto\Model\ResourceModel\Product $listingProductResource,
        \M2E\Otto\Model\Product\Repository $productRepository,
        \M2E\Otto\Model\ResourceModel\Tag $tagResource
    ) {
     ...
     * @param int[] $ids
     *
     * @return \M2E\Otto\Model\Tag\ListingProduct\Relation[]
     */
    public function findRelationsByProductIds(array $ids): array
    {
        $collection = $this->relationCollectionFactory->create();
        $collection->addFieldToFilter(
            \M2E\Otto\Model\ResourceModel\Tag\ListingProduct\Relation::COLUMN_LISTING_PRODUCT_ID,
            [
                'in' => array_unique($ids),
            ]
        );
        ...
        $result = [];
        /** @var \M2E\Otto\Model\Tag\ListingProduct\Relation $item */
    ...
    public function getTagEntitiesWithoutHasErrorsTag(): array
    {
        ...
        $collection->getSelect()->columns([
            'main_table.' . \M2E\Otto\Model\ResourceModel\Tag::COLUMN_ID,
            'main_table.' . \M2E\Otto\Model\ResourceModel\Tag::COLUMN_TEXT,
            'main_table.' . \M2E\Otto\Model\ResourceModel\Tag::COLUMN_ERROR_CODE,
            'main_table.' . \M2E\Otto\Model\ResourceModel\Tag::COLUMN_CREATE_DATE,
        ]);

        $collection->getSelect()->where(
            \M2E\Otto\Model\ResourceModel\Tag::COLUMN_ERROR_CODE . ' != ?',
            \M2E\Otto\Model\Tag::HAS_ERROR_ERROR_CODE
        );
    ...
    private function getGroupedIssues(int $limit): array
    {
        ...
        $collection->getSelect()->where('tag.error_code != ?', \M2E\Otto\Model\Tag::HAS_ERROR_ERROR_CODE);
