...
namespace M2E\Otto\Model\Product\Ui;

class RuntimeStorage
{
    /** @var \M2E\Otto\Model\Product[] */
    private array $products;
    private \M2E\Otto\Model\Product\Repository $repository;

    public function __construct(\M2E\Otto\Model\Product\Repository $repository)
    {
    ...
    public function findProduct(int $id): ?\M2E\Otto\Model\Product
    {
