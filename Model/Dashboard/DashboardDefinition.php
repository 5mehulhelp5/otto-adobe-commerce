...
namespace M2E\Otto\Model\Dashboard;

class DashboardDefinition implements \M2E\Core\Model\Dashboard\DashboardDefinitionInterface
{
    private const NAME = 'm2e_otto';
    private const TITLE = 'M2E Otto';

    private \M2E\Otto\Model\Dashboard\Shipments\DefinitionFactory $shipmentDefinitionFactory;
    private \M2E\Otto\Model\Dashboard\Shipments\Definition $shipmentDefinition;
    private \M2E\Otto\Model\Dashboard\Errors\DefinitionFactory $errorsDefinitionFactory;
    private \M2E\Otto\Model\Dashboard\Errors\Definition $errorsDefinition;
    private \M2E\Otto\Model\Dashboard\ProductIssues\DefinitionFactory $productIssuesDefinitionFactory;
    private \M2E\Otto\Model\Dashboard\ProductIssues\Definition $productIssuesDefinition;
    private \M2E\Otto\Model\Dashboard\Products\DefinitionFactory $productsDefinitionFactory;
    private \M2E\Otto\Model\Dashboard\Products\Definition $productsDefinition;
    private \M2E\Otto\Model\Dashboard\Sales\DefinitionFactory $salesDefinitionFactory;
    private \M2E\Otto\Model\Dashboard\Sales\Definition $salesDefinition;

    public function __construct(
        \M2E\Otto\Model\Dashboard\Shipments\DefinitionFactory $shipmentDefinitionFactory,
        \M2E\Otto\Model\Dashboard\Errors\DefinitionFactory $errorsDefinitionFactory,
        \M2E\Otto\Model\Dashboard\ProductIssues\DefinitionFactory $productIssuesDefinitionFactory,
        \M2E\Otto\Model\Dashboard\Products\DefinitionFactory $productsDefinitionFactory,
        \M2E\Otto\Model\Dashboard\Sales\DefinitionFactory $salesDefinitionFactory
    ) {
