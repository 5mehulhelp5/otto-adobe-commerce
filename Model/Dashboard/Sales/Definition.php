...
namespace M2E\Otto\Model\Dashboard\Sales;

class Definition implements \M2E\Core\Model\Dashboard\Sales\DefinitionInterface
{
    private \M2E\Otto\Model\Dashboard\Sales\DataProvider $dataProvider;

    public function __construct(
        \M2E\Otto\Model\Dashboard\Sales\DataProvider $dataProvider
    ) {
