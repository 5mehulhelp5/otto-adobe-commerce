...
class OptionsFinder
{
    private \M2E\Otto\Model\Magento\Product $magentoProduct;
    ...
    private bool $isNeedToReturnFirstOptionValues;
    ...
    /**
     * @param \M2E\Otto\Model\Magento\Product $magentoProduct
     *
     * @return $this
     */
    public function setProduct(\M2E\Otto\Model\Magento\Product $magentoProduct)
    {
    ...
    {
        $this->channelOptions = \M2E\Otto\Helper\Data::toLowerCaseRecursive($options);
    ...
    {
        $this->channelOptions = $this->channelOptions + \M2E\Otto\Helper\Data::toLowerCaseRecursive($options);
    ...
    {
        $optionLabels = \M2E\Otto\Helper\Data::toLowerCaseRecursive($optionLabels);
    ...
    private function findMagentoValue(array $magentoOptionValues)
    {
        foreach ($magentoOptionValues as $optionValue) {
            $valueLabels = \M2E\Otto\Helper\Data::toLowerCaseRecursive($optionValue['labels']);
    ...
    {
        /** @psalm-suppress RedundantPropertyInitializationCheck */
        if (isset($this->isNeedToReturnFirstOptionValues)) {
