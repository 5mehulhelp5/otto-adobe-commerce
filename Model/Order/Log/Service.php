...
class Service
{
    ...
    private \M2E\Otto\Model\ResourceModel\Order\Log\CollectionFactory $orderLogCollection;

    public function __construct(
        \M2E\Otto\Model\Order\LogFactory $orderLogFactory,
        \M2E\Otto\Model\ResourceModel\Order\Log $orderLogResource,
        \M2E\Otto\Model\OrderFactory $orderFactory,
        \M2E\Otto\Model\ResourceModel\Order $orderResource,
        \M2E\Otto\Model\ResourceModel\Order\Log\CollectionFactory $orderLogCollection
    ) {
    ...
    /**
     * @param \M2E\Otto\Model\Order|int|string $order
    ...
    public function addMessage(
        ...
        if (!($order instanceof \M2E\Otto\Model\Order)) {
    ...
    private function findOrder(int $orderId): \M2E\Otto\Model\Order
    {
