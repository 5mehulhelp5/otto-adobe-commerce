...
namespace M2E\Otto\Helper\Module\Renderer;
...
class Description
{
    ...
    public function parseTemplate($text, \M2E\Otto\Model\Magento\Product $magentoProduct)
    {
    ...
    public function parseWithoutMagentoTemplate(string $text, \M2E\Otto\Model\Magento\Product $magentoProduct): string
    {
    ...
    private function insertAttributes($text, \M2E\Otto\Model\Magento\Product $magentoProduct)
    {
