...
class Wizard
{
    ...
    private $layout;
    /** @var \M2E\Otto\Helper\Module\Database\Structure */
    private $moduleDatabaseStructureHelper;
    /** @var \M2E\Otto\Helper\Data\Cache\Permanent */
    private $permanentCache;

    /**
     * @param \Magento\Framework\Code\NameBuilder $nameBuilder
     * @param \Magento\Framework\View\LayoutInterface $layout
     * @param \M2E\Otto\Model\ActiveRecord\Factory $activeRecordFactory
     * @param \Magento\Framework\App\ResourceConnection $resourceConnection
     * @param \M2E\Otto\Helper\Module\Database\Structure $moduleDatabaseStructureHelper
     * @param \M2E\Otto\Helper\Data\Cache\Permanent $permanentCache
     */
    public function __construct(
        ...
        \M2E\Otto\Helper\Module\Database\Structure $moduleDatabaseStructureHelper,
    ...
    /**
     * @param \M2E\Otto\Model\Wizard $wizard
     *
     * @return string|null
     */
    public function getNick(\M2E\Otto\Model\Wizard $wizard): ?string
    {
    ...
    public function getActiveBlockerWizard(string $view): ?\M2E\Otto\Model\Wizard
    {
        $wizards = $this->getAllWizards($view);
    ...
    private function loadCache(): void
    {
        ...
        $tableName = $this->moduleDatabaseStructureHelper
            ->getTableNameWithPrefix('m2e_otto_wizard');
        ...
        usort($this->cache, function ($a, $b) {
            if ($a['type'] != $b['type']) {
                return $a['type'] == \M2E\Otto\Helper\Module\Wizard::TYPE_BLOCKER ? -1 : 1;
            }
    ...
    private function setConfigValue($nick, $key, $value)
    {
        ...
        $tableName = $this->moduleDatabaseStructureHelper->getTableNameWithPrefix('m2e_otto_wizard');
