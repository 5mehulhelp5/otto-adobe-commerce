...
namespace M2E\Otto\Helper\Component;
...
class Otto
{
    ...
    private \M2E\Otto\Helper\Data\Cache\Permanent $cachePermanent;

    public function __construct(
        \M2E\Otto\Helper\Data\Cache\Permanent $cachePermanent
    ) {
    ...
    {
        $this->cachePermanent->removeTagValues('Otto');
    }
