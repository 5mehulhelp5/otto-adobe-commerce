...
class General extends Magento\AbstractBlock
{
    ...
    public \M2E\Otto\Helper\View $viewHelper;
    ...
    protected function _beforeToHtml()
    {
        ...
        $this->jsUrl->addUrls([
            'otto_skin_url' => $this->getViewFileUrl('M2E_Otto'),
            'general/getCreateAttributeHtmlPopup' => $this->getUrl('*/general/getCreateAttributeHtmlPopup'),
        ]);

        /**
         * otto_config table may be missing if migration is going on
         */
        $areImportantTablesExist = $this
            ->objectManager
            ->get(\M2E\Otto\Helper\Module::class)->areImportantTablesExist();

        $this->blockNoticesShow = $areImportantTablesExist
            ? $this->objectManager
                ->get(\M2E\Otto\Helper\Module\Configuration::class)->getViewShowBlockNoticesMode()
            : 0;
