...
abstract class Content extends \M2E\Otto\Block\Adminhtml\Magento\Form\AbstractForm
{
    ...
    private \M2E\Otto\Model\Registration\UserInfo\Repository $userInfoRepository;
    protected \M2E\Otto\Helper\Magento\Admin $magentoAdminHelper;
    private \M2E\Otto\Helper\Module\License $helperModuleLicense;
    private \M2E\Otto\Helper\Magento $magentoHelper;

    public function __construct(
        \M2E\Otto\Helper\Magento $magentoHelper,
        \M2E\Otto\Helper\Module\License $helperModuleLicense,
        \M2E\Otto\Model\Registration\UserInfo\Repository $manager,
        \Magento\Backend\Model\Auth\Session $authSession,
        \M2E\Otto\Helper\Magento\Admin $magentoAdminHelper,
...
of your Trial and Paid terms, control your License Key details, and more.',
                \M2E\Otto\Helper\Module\Support::WEBSITE_PRIVACY_URL,
                \M2E\Otto\Helper\Module\Support::ACCOUNTS_URL
            )
        );
    ...
    protected function _prepareForm()
    {
        ...
        $fieldset->addField(
            ...
            [
                ...
                'class' => 'Otto-validate-email validate-length maximum-length-80',
                'required' => true,
...
CSS
            ...
            $privacyUrl = \M2E\Otto\Helper\Module\Support::WEBSITE_PRIVACY_URL;
            $termsUrl = \M2E\Otto\Helper\Module\Support::WEBSITE_TERMS_URL;
