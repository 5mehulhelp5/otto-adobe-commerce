...
abstract class Installation extends AbstractWizard
{
     ...
     * @param \M2E\Otto\Helper\Module\Wizard $wizardHelper
     * @param \M2E\Otto\Block\Adminhtml\Magento\Context\Widget $context
     * @param array $data
     */
    ...
    protected function _toHtml()
    {
        ...
        $helpBlock = $this->getLayout()
                          ->createBlock(\M2E\Otto\Block\Adminhtml\HelpBlock::class, 'wizard.help.block')
                          ->setData(
                              [
                                  'no_collapse' => true,
                                  'no_hide' => true,
