...
namespace M2E\Otto\Block\Adminhtml\Magento\Payment;
...
class Info extends \Magento\Payment\Block\Info
{
    ...
    protected $_template = 'M2E_Otto::magento/order/payment/info.phtml';
    ...
    {
        return (string)$this->getInfo()->getAdditionalInformation('channel_order_number');
    }
