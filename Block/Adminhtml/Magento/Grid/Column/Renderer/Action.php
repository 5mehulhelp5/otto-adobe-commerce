...
namespace M2E\Otto\Block\Adminhtml\Magento\Grid\Column\Renderer;

use M2E\Otto\Block\Adminhtml\Magento\Renderer;
use M2E\Otto\Block\Adminhtml\Traits;
use M2E\Otto\Model\Product as ListingProduct;
...
onchange="OttoVarienGridAction.execute(this, '{$itemId}');">
    <option value=""></option>
...
HTML;
    ...
    protected function _toLinkHtml($action, \Magento\Framework\DataObject $row)
    {
        ...
        $action['onclick'] = "OttoVarienGridAction.execute(this, '$itemId')";
