...
abstract class AbstractHorizontalStaticTabs extends \M2E\Otto\Block\Adminhtml\Magento\AbstractBlock
{
    ...
    protected $_template = 'M2E_Otto::magento/tabs/horizontal_static.phtml';
    ...
    protected function _toHtml()
    {
        ...
        if (!empty($styles)) {
            $this->css->add('.otto-tabs-horizontal-static{ ' . $styles . ' }');
        }
