...
namespace M2E\Otto\Block\Adminhtml\Magento\Button;

/**
 * Class \M2E\Otto\Block\Adminhtml\Magento\Button\MagentoAttribute
 */
class MagentoAttribute extends \M2E\Otto\Block\Adminhtml\Magento\Button
{
        ...
        if ($this->getDataAttribute()) {
            foreach ($this->getDataAttribute() as $key => $attr) {
                $attributes['data-' . $key] = is_scalar($attr)
                    ? $attr : \M2E\Otto\Helper\Json::encode($attr);
            }
        }
