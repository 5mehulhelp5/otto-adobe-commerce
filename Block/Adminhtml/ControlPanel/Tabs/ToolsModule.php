...
/**
 * Class \M2E\Otto\Block\Adminhtml\ControlPanel\Tabs\ToolsModule
 */
class ToolsModule extends AbstractBlock
{
    ...
    protected function _beforeToHtml()
    {
        $this->setChild(
            'tabs',
            $this->getLayout()->createBlock(\M2E\Otto\Block\Adminhtml\ControlPanel\Tabs\ToolsModule\Tabs::class)
        );
