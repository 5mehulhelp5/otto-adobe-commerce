...
namespace M2E\Otto\Block\Adminhtml\ControlPanel\Tabs\Database\Table;

use M2E\Otto\Block\Adminhtml\ControlPanel\Tabs\Database\Table\Column\Filter\Select as SelectFilter;
...
class Grid extends AbstractGrid
{
    ...
    private \M2E\Otto\Model\ControlPanel\Database\TableModel $tableModel;
    ...
    {
        $collection = $this->tableModel->createModel()->getCollection();
    ...
    protected function _prepareColumns()
    {
        foreach ($this->tableModel->getColumns() as $column) {
            ...
            if ($this->getColumnType($column) === 'datetime') {
                ...
                $params['filter'] = \M2E\Otto\Block\Adminhtml\Magento\Grid\Column\Filter\Datetime::class;
            }
            ...
            if (
                ...
                $columnData = [
                    ...
                    'filter' => \M2E\Otto\Block\Adminhtml\Magento\Grid\Column\Filter\Range::class,
                    'sortable' => true,
    ...
    protected function _beforeToHtml()
    {
        ...
        $this->js->addRequireJs(
            [
                'jQuery' => 'jquery',
                'l' => 'Otto/ControlPanel/Database/Grid',
            ],
            <<<JS
...
HTML;
    ...
    /**
     * @param \M2E\Otto\Model\ResourceModel\OperationHistory\Collection $collection
    ...
    public function getTableModel(): \M2E\Otto\Model\ControlPanel\Database\TableModel
    {
