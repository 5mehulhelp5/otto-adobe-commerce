...
namespace M2E\Otto\Block\Adminhtml\ControlPanel\Tabs\Database;
...
class Grid extends \M2E\Otto\Block\Adminhtml\Magento\Grid\AbstractGrid
{
    ...
    private \M2E\Otto\Model\ResourceModel\Collection\CustomFactory $customCollectionFactory;
    ...
    protected function callbackFilterTitle($collection, $column)
    {
        ...
        $this->getCollection()->addFilter(
            'table_name',
            $value,
            \M2E\Otto\Model\ResourceModel\Collection\Custom::CONDITION_LIKE
        );
    }
    ...
    protected function callbackFilterMatch($collection, $column)
    {
        ...
        $this->getCollection()->addFilter(
            $field,
            $value,
            \M2E\Otto\Model\ResourceModel\Collection\Custom::CONDITION_MATCH
        );
    }
}
