...
use M2E\Otto\Block\Adminhtml\Magento\Grid\AbstractGrid as WidgetAbstractGrid;
use M2E\Otto\Model\ResourceModel\Collection\Custom;
...
class Grid extends WidgetAbstractGrid
{
    ...
    /** @var \M2E\Otto\Model\ResourceModel\Collection\CustomFactory */
    protected $customCollectionFactory;

    /** @var ObjectManagerInterface */
    protected $objectManager;

    /** @var \M2E\Otto\Model\ControlPanel\Inspection\Repository $repository */
    private $repository;
...
{$value}
<div class="Otto-field-tooltip-to-right admin__field-tooltip">
...
HTML;
    ...
    protected function _beforeToHtml()
    {
        ...
        $this->js->addOnReadyJs(
            <<<JS
require(['domReady', 'Otto/ControlPanel/Inspection'], function() {
