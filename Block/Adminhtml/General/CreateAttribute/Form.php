...
namespace M2E\Otto\Block\Adminhtml\General\CreateAttribute;

use M2E\Otto\Block\Adminhtml\Magento\Form\AbstractForm;
use M2E\Otto\Model\Magento\Attribute\Builder as AttributeBuilder;
...
class Form extends AbstractForm
{
    ...
    /** @var \M2E\Otto\Helper\Magento\AttributeSet */
    ...
    protected function _prepareForm()
    {
        ...
        $classes = 'validate-length maximum-length-30 Otto-validate-attribute-code ';
        $classes .= 'Otto-validate-attribute-code-to-be-unique';
    ...
    protected function _toHtml()
    {
        ...
        $this->jsPhp->addConstants(
            \M2E\Otto\Helper\Data::getClassConstants(\M2E\Otto\Model\Magento\Attribute\Builder::class)
        );
        ...
        jQuery.validator.addMethod('Otto-validate-attribute-code', function(value, element) {
            return handler.validateAttributeCode(value, element);
        }, Otto.translator.translate('Invalid attribute code'));

        jQuery.validator.addMethod('Otto-validate-attribute-code-to-be-unique', function(value, element) {
            return handler.validateAttributeCodeToBeUnique(value, element);
        }, Otto.translator.translate('Attribute with the same code already exists'));
JS
        );
