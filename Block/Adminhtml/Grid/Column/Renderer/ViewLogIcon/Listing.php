...
use M2E\Otto\Model\Listing\Log;
...
class Listing extends \Magento\Backend\Block\Widget\Grid\Column\Renderer\Text
{
    ...
    public function render(\Magento\Framework\DataObject $row)
    {
        ...
        $dbSelect = $connection->select()
                               ...
                               ->order(['id DESC'])
                               ->limit(\M2E\Otto\Block\Adminhtml\Log\Grid\LastActions::PRODUCTS_LIMIT);
    ...
    {
        $summary = $this->getLayout()->createBlock(\M2E\Otto\Block\Adminhtml\Listing\Log\Grid\LastActions::class)
                        ->setData([
