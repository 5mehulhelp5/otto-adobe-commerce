...
namespace M2E\Otto\Block\Adminhtml\HealthStatus;

use M2E\Otto\Model\HealthStatus\Task\IssueType;
use M2E\Otto\Model\HealthStatus\Task\InfoType;
...
class Tabs extends \M2E\Otto\Block\Adminhtml\Magento\Tabs\AbstractTabs
{
    ...
    private \M2E\Otto\Model\HealthStatus\Task\Result\Set $resultSet;
    ...
    protected function _prepareLayout()
    {
        ...
        /** @var \M2E\Otto\Block\Adminhtml\HealthStatus\Tabs\Dashboard $tabObj */
        $tabObj = $this->getLayout()->createBlock(
            \M2E\Otto\Block\Adminhtml\HealthStatus\Tabs\Dashboard::class,
            '',
            [
                'resultSet' => $resultSet,
            ]
        ...
        foreach ($this->resultSet->getByType(IssueType::TYPE) as $result) {
            ...
            /** @var \M2E\Otto\Block\Adminhtml\HealthStatus\Tabs\IssueGroup $tabObj */
            $tabObj = $this->getLayout()->createBlock(
                \M2E\Otto\Block\Adminhtml\HealthStatus\Tabs\IssueGroup::class,
                '',
                [
                    'resultSet' => $resultSet,
                ]
            ...
            $this->addTab('issue_tab_' . $resultSet->getTabKey($result), [
                'label' => __($result->getTabName()),
                'title' => __($result->getTabName()),
                'content' => $tabObj->toHtml(),
                'class' => $tabClass,
            ]);
        ...
        // ---------------------------------------
        /** @var \M2E\Otto\Block\Adminhtml\HealthStatus\Tabs\Notifications $tabObj */
        $tabObj = $this->getLayout()->createBlock(
            \M2E\Otto\Block\Adminhtml\HealthStatus\Tabs\Notifications::class
        );
