...
use M2E\Otto\Model\HealthStatus\Notification\Settings;
use M2E\Otto\Model\HealthStatus\Task\Result;

class Notifications extends \M2E\Otto\Block\Adminhtml\Magento\Form\AbstractForm
{
    private \Magento\Backend\Model\Auth $auth;
    ...
    protected function _prepareForm()
    {
        ...
        $button = $this->getLayout()->createBlock(
            \M2E\Otto\Block\Adminhtml\Magento\Button::class,
            '',
            [
                'data' => [
                    'id' => 'submit_button',
    ...
    protected function _beforeToHtml()
    {
        ...
        $this->jsPhp->addConstants(
            [
                '\M2E\Otto\Model\HealthStatus\Notification\Settings::MODE_EMAIL'
                => \M2E\Otto\Model\HealthStatus\Notification\Settings::MODE_EMAIL,
            ]
        );

        $this->js->addRequireJs(
            ['hS' => 'Otto/HealthStatus'],
            <<<JS
