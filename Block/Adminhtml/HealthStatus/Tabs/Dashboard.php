...
class Dashboard extends \M2E\Otto\Block\Adminhtml\Magento\Form\AbstractForm
{
    ...
    protected function _prepareForm()
    {
        ...
        if ($this->latestPublicVersion) {
            ...
            $documentationArticleUrl = 'https://docs-m2.m2epro.com/m2e-otto-release-notes-policy';
            $fieldSet->addField(
