...
namespace M2E\Otto\Block\Adminhtml\Listing\Log;

class ErrorsSummary extends \M2E\Otto\Block\Adminhtml\Magento\AbstractBlock
{
    public array $errors = [];
    ...
    protected function _beforeToHtml()
    {
        ...
        $dbSelect = $connection->select()
                               ...
                               ->where('`type` = ?', \M2E\Otto\Model\Log\AbstractModel::TYPE_ERROR)
                               ->group('description')
