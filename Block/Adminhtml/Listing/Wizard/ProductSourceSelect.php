...
class ProductSourceSelect extends \M2E\Otto\Block\Adminhtml\Magento\Form\AbstractContainer
{
    use WizardTrait;
        ...
        $this->prepareButtons(
            [
                ...
                'onclick' => sprintf(
                    ...
                    $this->getUrl(
                        '*/listing_wizard_productSource/complete',
    ...
    {
        $this->addChild('form', \M2E\Otto\Block\Adminhtml\Listing\Wizard\ProductSource\Form::class);
