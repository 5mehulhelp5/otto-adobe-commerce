...
class ReviewUnmanaged extends \M2E\Otto\Block\Adminhtml\Magento\AbstractContainer
{
    use ReviewTrait;
        ...
        $buttonBlock = $this->getLayout()
                            ...
                            ->setData(
                                [
                                    ...
                                    'onclick' => 'setLocation(\'' . $this->generateCompleteUrl(false, $this->getUrl('*/Otto_listing_unmanaged/index')) . '\');',
                                    'class' => 'primary go',
                                ],
                            );
