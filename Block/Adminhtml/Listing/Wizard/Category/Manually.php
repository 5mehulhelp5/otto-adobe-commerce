...
class Manually extends \M2E\Otto\Block\Adminhtml\Magento\Grid\AbstractContainer
{
    ...
    protected function _prepareLayout()
    {
        $gridBlock = $this
            ->getLayout()
            ->createBlock(
                \M2E\Otto\Block\Adminhtml\Listing\Wizard\Category\ModeManually\Grid::class,
                '',
                [
