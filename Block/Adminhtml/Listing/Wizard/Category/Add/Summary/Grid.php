...
namespace M2E\Otto\Block\Adminhtml\Listing\Wizard\Category\Add\Summary;

class Grid extends \M2E\Otto\Block\Adminhtml\Category\Grid
{
    /** @var \M2E\Otto\Helper\Module\Database\Structure */
    private $databaseHelper;

    public function __construct(
        \M2E\Otto\Model\ResourceModel\Magento\Category\CollectionFactory $categoryCollectionFactory,
...
HTML;
        ...
        $help = $this->getLayout()->createBlock(\M2E\Otto\Block\Adminhtml\HelpBlock::class)->setData([
            'content' => __(
...
HTML;
        ...
        if (!$this->getRequest()->getParam('grid')) {
            $this->js->add(
                <<<JS
    require([
        'Otto/Listing/Wizard/Product/Summary/Grid'
    ],function() {
