...
namespace M2E\Otto\Block\Adminhtml\Listing\Wizard\Category\ModeManually;

use M2E\Otto\Block\Adminhtml\Otto\Grid\Column\Filter\CategoryMode as CategoryModeFilter;
use M2E\Otto\Model\ResourceModel\Listing\Wizard\Step as StepResource;
...
class Grid extends \M2E\Otto\Block\Adminhtml\Magento\Grid\AbstractGrid
{
    ...
    private \M2E\Otto\Model\ResourceModel\Listing\Wizard\Product $productResource;
    ...
    public function __construct(
        ...
        \M2E\Otto\Model\ResourceModel\Listing\Wizard\Product $productResource,
    ...
    protected function _prepareCollection()
    {
        ...
        $collection->joinTable(
            ...
            sprintf(
                '%s = entity_id',
                \M2E\Otto\Model\ResourceModel\Listing\Wizard\Product::COLUMN_MAGENTO_PRODUCT_ID,
            ),
            [
                'product_id' => \M2E\Otto\Model\ResourceModel\Listing\Wizard\Product::COLUMN_ID,
            ],
            sprintf(
                '{{table}}.%s = %s',
    ...
    public function callbackColumnCategories($value, $row, $column, $isExport)
    {
        ...
        $iconSrc = $this->getViewFileUrl('M2E_Otto::images/warning.png');
...
JS,
        ...
        $this->jsUrl->add(
            $this->getUrl('*/listing_wizard_category/complete'),
            'listing_wizard_category/complete',
        );
...
require([
    ...
    'Otto/Listing/Wizard/Category/Mode/Manually/Grid'
], function(){
