...
{
    protected \M2E\Otto\Helper\Magento\Product $magentoProductHelper;
    protected \M2E\Otto\Model\ResourceModel\Magento\Product\CollectionFactory $magentoProductCollectionFactory;
    protected \Magento\Catalog\Model\Product\Type $type;
    private \M2E\Otto\Model\ResourceModel\Listing\Wizard $wizardResource;
    private \M2E\Otto\Model\ResourceModel\Listing\Wizard\Product $listingWizardProductResource;
    ...
    public function _construct()
    {
        ...
        // ---------------------------------------
        $this->setId('ottoListingProductGrid' . $this->getListing()->getId());
        // ---------------------------------------
        ...
        $collection->addFieldToFilter(
            [
                [
                    'attribute' => 'type_id',
                    'in' => [
                        \M2E\Otto\Helper\Magento\Product::TYPE_SIMPLE
                    ],
                ],
            ],
        );
    ...
    protected function _prepareColumns()
    {
        ...
        $this->addColumn('price', [
            ...
            'width' => '100px',
            'type' => 'price',
            'filter' => \M2E\Otto\Block\Adminhtml\Magento\Grid\Column\Filter\Price::class,
...
JS,
        ...
        $this->js->add(
            <<<JS
    require([
        'Otto/Listing/Wizard/Product/Add',
