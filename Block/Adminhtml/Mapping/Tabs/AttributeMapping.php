...
namespace M2E\Otto\Block\Adminhtml\Mapping\Tabs;
...
class AttributeMapping extends \M2E\Otto\Block\Adminhtml\Magento\Form\AbstractForm
{
    ...
    protected function _beforeToHtml()
    {
        $this->jsUrl->add(
            ...
            \M2E\Otto\Block\Adminhtml\Mapping\Tabs::TAB_ID_MAPPING_ATTRIBUTES
        );
    ...
    public function makeMagentoAttributesDropDownHtml(
        ...
        $html = sprintf(
            '<select id="attribute-%1$s" name="general_attributes[%1$s]" class="%2$s">',
