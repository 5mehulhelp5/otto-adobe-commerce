...
class Edit extends \M2E\Otto\Block\Adminhtml\Magento\AbstractContainer
{
    ...
    public function _construct()
    {
        ...
        $this->setId('ottoTemplateCategoryChooserEdit');
        $this->setTemplate('otto/template/category/chooser/edit.phtml');
    ...
    private function renderWithTabs(): string
    {
        $tabsContainer = $this->getLayout()->createBlock(
            \M2E\Otto\Block\Adminhtml\Otto\Template\Category\Chooser\Tabs::class,
        );
