...
namespace M2E\Otto\Block\Adminhtml\Otto\Template\Description\Preview;
...
class Form extends AbstractForm
{
    protected function _prepareForm()
    {
        ...
        $viewButton = $this->getLayout()->createBlock(\M2E\Otto\Block\Adminhtml\Magento\Button::class);
        $viewButton->addData([
            'label' => __('View'),
            'type' => 'submit',
        ]);

        $randomButton = $this->getLayout()->createBlock(\M2E\Otto\Block\Adminhtml\Magento\Button::class);
