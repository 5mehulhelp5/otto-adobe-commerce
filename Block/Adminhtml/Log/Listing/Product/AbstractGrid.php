...
abstract class AbstractGrid extends \M2E\Otto\Block\Adminhtml\Log\Listing\AbstractGrid
{
    ...
    protected function getLogHash($type): int
    {
    ...
    public function callbackColumnListingTitleID($value, $row, $column, $isExport)
    {
        ...
        $manageUrl = $this->getUrl('*/otto_listing/view', $urlData);
    ...
    {
        $allActions = \M2E\Otto\Helper\Module\Log::getActionsTitlesByClass(
