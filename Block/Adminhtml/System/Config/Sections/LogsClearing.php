...
use M2E\Otto\Model\Log\Clearing as LogClearing;

class LogsClearing extends \M2E\Otto\Block\Adminhtml\System\Config\Sections
{
    /** @var array */
    private $modes;
    /** @var array */
    ...
    protected function _prepareForm()
    {
        ...
        $fieldSet = $form->addFieldset(
            ...
            [
                'legend' => __('M2E Otto Listings Logs & Events Clearing'),
                'collapsable' => false,
            ]
        );
        ...
        $tooltip = $this->getTooltipHtml(
            (string)__('Enables automatic clearing of Log data. Can help reduce Database size.')
        );
...
HTML
        ...
        $fieldSet->addField(
            ...
            [
                ...
                'class' => 'Otto-logs-clearing-interval',
                'required' => true,
                'tooltip' => __(
...
HTML
    ...
    protected function _prepareLayout(): void
    {
        ...
        $this->jsUrl->add($this->getUrl('m2e_otto/settings_logsClearing/save'), self::SECTION_ID_LOGS_CLEARING);
        $this->jsUrl->add($this->getUrl('m2e_otto/settings_logsClearing/save'), 'formSubmit');
