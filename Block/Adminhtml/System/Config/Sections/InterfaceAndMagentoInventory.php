...
class InterfaceAndMagentoInventory extends \M2E\Otto\Block\Adminhtml\System\Config\Sections
{
    /** @var \M2E\Otto\Helper\Module\Configuration */
    private $configurationHelper;
    private \M2E\Otto\Model\Product\InspectDirectChanges\Config $inspectDirectChangesConfig;

    public function __construct(
        \M2E\Otto\Model\Product\InspectDirectChanges\Config $inspectDirectChangesConfig,
        \M2E\Otto\Helper\Module\Configuration $configurationHelper,
...
<p>Click <strong>Save Config</strong> if you make any changes.</p>',
                    ['url' => 'https://docs-m2.m2epro.com/m2e-otto-shop-global-settings'],
                ),
            ]
        );
    ...
    protected function _prepareLayout()
    {
        ...
        $this->jsUrl->add(
            $this->getUrl('Otto/settings_interfaceAndMagentoInventory/restoreRememberedChoices'),
