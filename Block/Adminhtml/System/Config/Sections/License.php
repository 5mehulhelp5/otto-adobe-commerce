...
namespace M2E\Otto\Block\Adminhtml\System\Config\Sections;
    ...
    protected function _prepareForm()
    {
        ...
        $form->addField(
            ...
            [
                ...
                'no_hide' => true,
                'content' => __(
                    '<p>To use M2E Otto, you need to register on M2E Accounts and generate a
License Key.</p><br>

                    <p>Your email address used during the initial setup of M2E Otto automatically
                    registers you on
                    M2E Accounts. After logging in, you can manage your Subscription and Billing information.</p><br>

                    <p>License Key is a unique identifier of M2E Otto instance which is generated automatically
                    ...
                    to M2E Otto License section. Click <strong>Save</strong> after the changes are made.</p><br>

                    <p><strong>Note:</strong> If you need some assistance to activate your M2E Otto instance,
        ...
        $fieldSet = $form->addFieldset(
            ...
            [
                'legend' => $this->key == '' ? __('General') : __('Additional'),
                'collapsable' => false,
            ]
        );
    ...
    protected function prepareLicenseData()
    {
        ...
        // ---------------------------------------
        $label = $this->key == '' ? __('Use Existing License') : __('Change License');
        $data = [
            'label' => $label,
    ...
    protected function _prepareLayout()
    {
        ...
        $this->jsUrl->add($this->getUrl('m2e_otto/settings_license/refreshStatus'), 'settings_license/refreshStatus');
        $this->jsUrl->add($this->getUrl('m2e_otto/settings_license/change'), 'settings_license/change');
        $this->jsUrl->add($this->getUrl('m2e_otto/settings_license/section'), 'settings_license/section');

        $this->js->addRequireJs(
            [
                'l' => 'Otto/Settings/License',
            ],
            <<<JS
