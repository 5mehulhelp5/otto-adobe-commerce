...
class BeforeGetToken extends Installation
{
    ...
    public function execute()
    {
        ...
        try {
            $redirectUrl = $this->accessUrlGenerator->getGrantAccessUrlForCreateFromWizard($title, $mode);
            ...
            if (
                ...
                $error = __(
                    'The %channel_title token obtaining is currently unavailable.<br/>Reason: %error_message </br>Go to the <a href="%url" target="_blank">License Page</a>.',
                    [
