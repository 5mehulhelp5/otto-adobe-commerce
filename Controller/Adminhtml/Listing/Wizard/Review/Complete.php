...
class Complete extends \M2E\Otto\Controller\Adminhtml\AbstractListing
{
    ...
    private \M2E\Otto\Model\Listing\Wizard\CompleteProcessor $completeProcessor;

    public function __construct(
        \M2E\Otto\Model\Listing\Wizard\ManagerFactory $wizardManagerFactory,
        \M2E\Otto\Model\Listing\Wizard\CompleteProcessor $completeProcessor,
    ...
    public function execute()
    {
        ...
        $wizardManager->completeStep(
            \M2E\Otto\Model\Listing\Wizard\StepDeclarationCollectionFactory::STEP_REVIEW,
        );
