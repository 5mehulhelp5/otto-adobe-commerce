...
class ActionService
{
    ...
    /**
     * @param \M2E\Otto\Model\Product[] $products
     * @param \M2E\Otto\Model\Otto\Listing\Product\Action\Manual\Realtime\AbstractRealtime $processor
     * @param array $params
     *
     * @return array
     */
    private function processRealtime(
        array $products,
        \M2E\Otto\Model\Otto\Listing\Product\Action\Manual\Realtime\AbstractRealtime $processor,
        array $params
    ): array {
    ...
    /**
     * @param \M2E\Otto\Model\Product[] $products
     * @param \M2E\Otto\Model\Otto\Listing\Product\Action\Manual\Schedule\AbstractSchedule $processor
     * @param array $params
     *
     * @return array
     */
    private function createScheduleAction(
        array $products,
        \M2E\Otto\Model\Otto\Listing\Product\Action\Manual\Schedule\AbstractSchedule $processor,
        array $params
    ): array {
        $logsActionId = $this->listingLogService->getNextActionId();
        if (empty($products)) {
