...
class Configure extends \M2E\Otto\Controller\Adminhtml\AbstractOrder
{
    ...
    public function execute()
    {
        ...
        $fromDate = \M2E\Otto\Helper\Date::timezoneDateToGmt($from);
        $toDate = \M2E\Otto\Helper\Date::timezoneDateToGmt($to);
