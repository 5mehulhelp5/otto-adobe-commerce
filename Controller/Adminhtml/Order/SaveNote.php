...
class SaveNote extends \M2E\Otto\Controller\Adminhtml\AbstractOrder
{
    private \M2E\Otto\Model\Order\Note\Create $createService;
    private \M2E\Otto\Model\Order\Note\Update $updateService;
    private \M2E\Otto\Model\Order\Repository $orderRepository;

    public function __construct(
        \M2E\Otto\Model\Order\Note\Create $createService,
        \M2E\Otto\Model\Order\Note\Update $updateService,
    ...
    public function execute()
    {
        ...
        if ($noteId = $this->getRequest()->getParam('note_id')) {
            ...
            $this->createService->createCustomNote(
                $order,
                $noteText
            );
        }
