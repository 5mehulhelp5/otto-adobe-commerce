    ...
    window.ControlPanelDatabaseGrid = Class.create(Grid, {
        ...
        deleteTableRows: function (id) {
            ...
            confirmAction = function () {
                new Ajax.Request(Otto.url.get('controlPanel/deleteTableRows'), {
                    method: 'post',
                    parameters: {
                        ids: selectedIds
                    },
        ...
        openTableCellsPopup: function (mode) {
            ...
            new Ajax.Request(Otto.url.get('controlPanel/getTableCellsPopupHtml'), {
                method: 'post',
                parameters: {
        ...
        confirmUpdateCells: function () {
            ...
            new Ajax.Request(Otto.url.get('controlPanel/updateTableCells'), {
                method: 'post',
                asynchronous: false,
        ...
        confirmAddRow: function () {
            ...
            new Ajax.Request(Otto.url.get('controlPanel/addTableRow'), {
                method: 'post',
                asynchronous: false,
                parameters: Form.serialize($('controlPanel_tabs_database_table_cells_popup_form')),
                onSuccess: function (transport) {
