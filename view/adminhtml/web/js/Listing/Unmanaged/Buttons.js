define(['uiElement', 'mage/translate', 'Otto/Plugin/Confirm'], (uiElement, $t, confirm) => {
    'use strict';

    return uiElement.extend({
        defaults: {
            resetBtnTemplate: 'M2E_Otto/listing/unmanaged/button/reset',
            resetBtnLabel: $t('Reset Unmanaged Listings'),
            isShowResetBtn: false,
            urlResetUnmanaged: '',

            enableBtnTemplate: 'M2E_Otto/listing/unmanaged/button/enable',
            enableBtnLabel: $t('Enable Unmanaged Listings Import'),
            isShowSettingsBtn: false,
            urlOpenSettings: '',

            inProgressBtnTemplate: 'M2E_Otto/listing/unmanaged/button/in_progress',
        ...
        confirmReset() {
            ...
            const content1 = $t('This action will remove all the items from Otto Unmanaged Listings. It will take some time to import them again.');
