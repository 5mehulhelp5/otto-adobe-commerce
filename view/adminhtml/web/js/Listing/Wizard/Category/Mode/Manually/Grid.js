define([
    ...
    window.ListingWizardCategoryModeManuallyGrid = Class.create(Grid, {
        ...
        editCategories: function () {
            ...
            new Ajax.Request(Otto.url.get('listing_wizard_category/chooserBlockModeManually'), {
                method: 'post',
                asynchronous: true,
                parameters: {
        ...
        resetCategories: function (id) {
            ...
            new Ajax.Request(Otto.url.get('listing_wizard_category/resetModeManually'), {
                method: 'post',
                asynchronous: true,
                parameters: {
        ...
        confirmCategoriesData: function () {
            ...
            const selectedCategory = OttoCategoryChooserObj.selectedCategory;
        ...
        saveCategoriesData: function (templateData) {
            ...
            new Ajax.Request(Otto.url.get('listing_wizard_category/saveModeManually'), {
                method: 'post',
                parameters: {
        ...
        completeCategoriesDataStep: function (validateCategory, validateSpecifics) {
            ...
            new Ajax.Request(Otto.url.get('listing_wizard_category/validateModeManually'), {
                method: 'post',
                asynchronous: true,
                parameters: {
                ...
                onSuccess: function (transport) {
                    ...
                    if (response.validation) {
                        return setLocation(
                            Otto.url.get('listing_wizard_category/complete', {'id': wizard_id})
                        );
                    }
