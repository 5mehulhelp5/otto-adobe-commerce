define([
    ...
    window.OttoListingCategory = Class.create(Common, {
        ...
        getChooserSelectedCategory: function () {
            return OttoCategoryChooserObj.selectedCategory;
        },

        getChooserSelectedAttributes: function () {
            return OttoCategoryChooserObj.selectedSpecifics;
        },

        editCategorySettings: function (id) {
            this.selectedProductsIds = id ? [id] : this.gridObj.getSelectedProductsArray();

            const url = Otto.url.get('listing_product_category_settings/edit');
        ...
        saveCategorySettings: function () {
            ...
            new Ajax.Request(Otto.url.get('otto_listing/saveCategoryTemplate'), {
                method: 'post',
                asynchronous: true,
                parameters: {
                    products_ids: self.selectedProductsIds.join(','),
                    template_category_id: selectedCategory.categoryId
                },
                onSuccess: function (transport) {
