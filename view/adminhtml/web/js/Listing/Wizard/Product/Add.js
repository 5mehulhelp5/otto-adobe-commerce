    ...
    window.ListingWizardProductAdd = Class.create(Common, {
        ...
        continue: function () {
            ...
            self.options.get_selected_products(function (selectedProducts) {
                ...
                if (!selectedProducts) {
                    self.alert(Otto.translator.translate('Please select the Products you want to perform the Action on.'));
                    return;
                }
        ...
        add: function (products) {
            ...
            const parts = self.makeProductsParts();
        ...
        sendPartsProducts: function (parts, partsCount) {
            ...
            new Ajax.Request(Otto.url.get('listing_wizard_product_add_with_id'), {
                method: 'post',
                parameters: {
                    products: partString,
                },
                onSuccess: function (transport) {
                    ...
                    if (percents <= 0) {
                        ...
                        setLocation(Otto.url.get('listing_wizard_product_complete_with_id'));
                    } else {
