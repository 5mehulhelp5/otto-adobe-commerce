define([
    ...
    'Otto/Action',
    'Otto/Plugin/ProgressBar',
    'Otto/Plugin/AreaWrapper'
], function (MessageObj) {
    ...
    window.ListingViewAction = Class.create(Action, {
        ...
        sendPartsOfProducts: function (parts, totalPartsCount, url, requestParams) {
            ...
            if (parts.length == 0) {
                ...
                self.progressBarObj.setStatus(Otto.translator.translate('task_completed_message'));
                ...
                if (combineResult == 'error') {
                    ...
                    var message = Otto.translator.translate('task_completed_error_message');
                    message = message.replace('%task_title%', self.progressBarObj.getTitle());
                    message = message.replace('%url%', Otto.url.get('logViewUrl'));
                    ...
                    new Ajax.Request(Otto.url.get('getErrorsSummary') + 'action_ids/' + actionIds + '/', {
                        method: 'get',
                    ...
                    var message = Otto.translator.translate('task_completed_warning_message');
                    message = message.replace('%task_title%', self.progressBarObj.getTitle());
                    message = message.replace('%url%', Otto.url.get('logViewUrl'));
            ...
            self.progressBarObj.setStatus(
                    str_replace(
                            '%product_title%',
                            partExecuteString,
                            Otto.translator.translate('sending_data_message')
                    )
            );
        ...
        listAction: function () {
            ...
            this.startActions(
                    Otto.translator.translate('listing_selected_items_message'),
                    Otto.url.get('runListProducts'),
        ...
        relistAction: function () {
            ...
            this.startActions(
                    Otto.translator.translate('relisting_selected_items_message'),
                    Otto.url.get('runRelistProducts'),
                    selectedProductsParts
            );
        },
        ...
        reviseAction: function () {
            ...
            this.startActions(
                    Otto.translator.translate('revising_selected_items_message'),
                    Otto.url.get('runReviseProducts'),
                    selectedProductsParts
            );
        },
        ...
        stopAction: function () {
            ...
            this.startActions(
                    Otto.translator.translate('stopping_selected_items_message'),
                    Otto.url.get('runStopProducts'),
                    selectedProductsParts
            );
        },
        ...
        stopAndRemoveAction: function () {
            ...
            this.startActions(
                    Otto.translator.translate('stopping_and_removing_selected_items_message'),
                    Otto.url.get('runStopAndRemoveProducts'),
                    selectedProductsParts
            );
        },
        ...
        previewItemsAction: function () {
            ...
            this.openWindow(
                    Otto.url.get('previewItems') + 'productIds/' + implode(',', orderedSelectedProductsArray)
