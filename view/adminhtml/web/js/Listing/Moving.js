define([
    ...
    window.ListingMoving = Class.create(Action, {
        ...
        openPopUp: function (gridHtml, popup_title, buttons) {
            ...
            if (typeof buttons === 'undefined') {
                buttons = [{
                    ...
                    text: Otto.translator.translate('Add New Listing'),
                    class: 'action-primary action-accept',
                    click: function () {
                        self.startListingCreation(Otto.url.get('add_new_listing_url'));
                    }
                }];
            }
        ...
        prepareData: function (parts, partsCount, isFirstPart) {
            ...
            new Ajax.Request(Otto.url.get('prepareData'), {
                method: 'post',
                parameters: {
        ...
        moveToListingGrid: function () {
            ...
            new Ajax.Request(Otto.url.get('moveToListingGridHtml'), {
                method: 'get',
                parameters: {
                    accountId: self.accountId,
                    ignoreListings: Otto.customData.ignoreListings
                },
                onSuccess: (function (transport) {
                    self.completeProgressBar();
                    self.openPopUp(transport.responseText, Otto.translator.translate('popup_title'));
                })
            });
        },
        ...
        submit: function (listingId, onSuccess) {
            ...
            new Ajax.Request(Otto.url.get('createListing'), {
                method: 'post',
                parameters: {
                    listingId: listingId
                },
