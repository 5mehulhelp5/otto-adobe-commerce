define([
    ...
    window.ListingEditListingStoreView = Class.create({
        ...
        openPopup: function (id = null) {
            ...
            new Ajax.Request(Otto.url.get('listing/selectStoreView'), {
                method: 'GET',
                parameters: {
                    id: listingId,
                },
                onSuccess: (function (transport) {
                    ...
                    modal({
                        title: Otto.translator.translate('Edit Listing Store View'),
                        type: 'popup',
                        modalClass: 'width-50',
                        buttons: [{
        ...
        saveListingStoreView: function () {
            ...
            confirm({
                ...
                actions: {
                    confirm: function () {
                        new Ajax.Request(Otto.url.get('listing/saveStoreView'), {
                            method: 'post',
