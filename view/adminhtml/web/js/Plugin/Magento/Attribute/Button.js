define([
    ...
    window.MagentoAttributeButton = Class.create({
        ...
        _template: "<fieldset class='fieldset admin__fieldset  Otto-fieldset'>" +
        ...
        init: function (element, callback) {
            ...
            var popup = jQuery(popupElement).modal({
                title: Otto.translator.translate(
                ...
                buttons: [{
                    ...
                    text: Otto.translator.translate('Insert'),
        ...
        _renderMagentoAttributes: function (containerElement) {
            ...
            var select = new Element('select',
                    _.extend({
                        ...
                        class: 'select admin__control-select Otto-custom-attribute-can-be-created',
            ...
            containerElement.innerHTML = _.template(this._template)({
                id: 'magento-attribute-select-' + this._id,
                title: Otto.translator.translate('Attribute'),
