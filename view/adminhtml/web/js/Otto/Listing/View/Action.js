define([
    'Otto/Listing/View/Action'
], function () {

    window.OttoListingViewAction = Class.create(ListingViewAction, {
        ...
        stopAction: function () {
            ...
            this.startActions(
                    ...
                    Otto.url.get('otto_listing/runStopProducts'),
        ...
        stopAndRemoveAction: function () {
            ...
            this.startActions(
                    ...
                    Otto.url.get('otto_listing/runStopAndRemoveProducts'),
                    selectedProductsParts,
                    requestParams
            );
        }
