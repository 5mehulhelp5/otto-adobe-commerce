define([
    ...
    window.OttoTemplateDescription = Class.create(Common, {

        // ---------------------------------------

        initialize: function () {
            jQuery.validator.addMethod('Otto-validate-description-mode', function (value, el) {
            ...
            jQuery.validator.addMethod('Otto-validate-description-template', function (value, el) {

                if ($('description_mode').value != Otto.php.constant('M2E_Otto_Model_Template_Description::DESCRIPTION_MODE_CUSTOM')) {
                    return true;
                }
            ...
            jQuery.validator.addMethod('Otto-validate-magento-product-id', function (value) {

                var isValidMagentoProductId = false;

                new Ajax.Request(Otto.url.get('otto_template_description/checkMagentoProductId'), {
                    method: 'post',
                    asynchronous: false,
                    parameters: {
                        product_id: value
            ...
            }, Otto.translator.translate('Please enter a valid Magento product ID.'));
        },
        ...
        initObservers: function () {
            ...
            $('title_mode')
                    .observe('change', OttoTemplateDescriptionObj.title_mode_change)
                    .simulate('change');

            $('description_mode')
                    .observe('change', OttoTemplateDescriptionObj.description_mode_change)
                    .simulate('change');

            $('custom_inserts_open_popup')
                    .observe('click', OttoTemplateDescriptionObj.customInsertsOpenPopup);
            ...
            if (typeof wysiwygdescription_template !== 'undefined') {
                $('description_template_show_hide_wysiwyg')
                        ...
                        .observe('click', OttoTemplateDescriptionObj.showHideWYSIWYG);
            } else {
        ...
        gallery_images_change: function () {
            ...
            console.log(galleryImagesInputValue === 0);
            // None
        ...
        title_mode_change: function () {
            var self = OttoTemplateDescriptionObj;
        ...
        description_mode_change: function () {
            ...
            if (this.value == Otto.php.constant('M2E_Otto_Model_Template_Description::DESCRIPTION_MODE_CUSTOM')) {
                if (viewEditCustomDescription) {
                ...
                if (typeof wysiwygdescription_template !== 'undefined' && $('description_editor_type').value == Otto.php.constant('M2E_Otto_Model_Template_Description::EDITOR_TYPE_SIMPLE')) {
        ...
        view_edit_custom_change: function () {
            if (
                    ...
                    && $('description_editor_type').value == Otto.php.constant('M2E_Otto_Model_Template_Description::EDITOR_TYPE_SIMPLE')
            ) {
                wysiwygdescription_template.toggle();
            }
        ...
        showHideWYSIWYG: function () {
            var label;
            if ($('description_editor_type').value == Otto.php.constant('M2E_Otto_Model_Template_Description::EDITOR_TYPE_TINYMCE')) {
                label = Otto.translator.translate('Show Editor');
                $('description_editor_type').value = Otto.php.constant('M2E_Otto_Model_Template_Description::EDITOR_TYPE_SIMPLE');
            } else {
                label = Otto.translator.translate('Hide Editor');
                $('description_editor_type').value = Otto.php.constant('M2E_Otto_Model_Template_Description::EDITOR_TYPE_TINYMCE');
            }
        ...
        initCustomInsertsPopup: function () {
            ...
            popup.modal({
                title: Otto.translator.translate('Custom Insertions'),
                type: 'slide',
                buttons: [],
                closed: function () {
                    OttoTemplateDescriptionObj.customInsertsOnClosePopup();
                }
            });
        },
        ...
        insertOttoAttribute: function () {
            var self = this;

            self.customInsertsClosePopup(function () {
                self.appendToTextarea('#value[' + $('custom_inserts_otto_attribute').value + ']#');
            });
        },
        ...
        initPreviewPopup: function () {
            ...
            if (!popup.find('form').length) {
                popup.wrapInner(new Element('form', {
                    ...
                    method: 'post',
                    target: '_blank',
                    action: Otto.url.get('otto_template_description/preview')
                }));
                this.initFormValidation('#description_preview_form');
            }

            popup.modal({
                title: Otto.translator.translate('Description Preview'),
                type: 'popup',
                buttons: [{
        ...
        openPreviewPopup: function () {
            if (
                    $('description_mode').value == Otto.php.constant('M2E_Otto_Model_Template_Description::DESCRIPTION_MODE_CUSTOM')
                    && !$('description_template').value.length
            ) {
                this.alert(Otto.translator.translate('Please enter Description Value.'));
                return;
            }
        ...
        selectProductIdRandomly: function () {
            ...
            new Ajax.Request(Otto.url.get('otto_template_description/getRandomMagentoProductId'), {
                method: 'post',
                parameters: {
