define([
    ...
    window.OttoTemplateSynchronization = Class.create(Common, {
        // ---------------------------------------
        ...
        initialize: function () {
            ...
            jQuery.validator.addMethod('Otto-validate-stop-relist-conditions-product-status', function (value, el) {

                if (OttoTemplateSynchronizationObj.isRelistModeDisabled()) {
                    return true;
                }

                if (OttoTemplateSynchronizationObj.isStopModeDisabled()) {
                    return true;
                }
                ...
                return true;
            }, Otto.translator.translate('Inconsistent Settings in Relist and Stop Rules.'));

            jQuery.validator.addMethod('Otto-validate-stop-relist-conditions-stock-availability', function (value, el) {
            ...
            jQuery.validator.addMethod('Otto-validate-stop-relist-conditions-item-qty', function (value, el) {
                ...
                switch (parseInt($('stop_qty_calculated').value)) {
                    ...
                    case Otto.php.constant('M2E_Otto_Model_Template_Synchronization::QTY_MODE_NONE'):
                        return true;
                        break;

                    case Otto.php.constant('M2E_Otto_Model_Template_Synchronization::QTY_MODE_YES'):
        ...
        initObservers: function () {
            ...
            //list
            $('list_mode')
                    .observe('change', OttoTemplateSynchronizationObj.listMode_change).simulate('change');

            $('list_qty_calculated')
                    .observe('change', OttoTemplateSynchronizationObj.listQtyChange)
                    .simulate('change');

            $('list_advanced_rules_mode')
                    .observe('change', OttoTemplateSynchronizationObj.listAdvancedRules_change)
                    .simulate('change');

            //relist
            $('relist_mode')
                    .observe('change', OttoTemplateSynchronizationObj.relistMode_change)
                    .simulate('change');

            $('relist_qty_calculated')
                    .observe('change', OttoTemplateSynchronizationObj.relistQtyChange)
                    .simulate('change');

            $('relist_advanced_rules_mode')
                    .observe('change', OttoTemplateSynchronizationObj.relistAdvancedRules_change)
                    .simulate('change');

            //revise
            $('revise_update_qty')
                    .observe('change', OttoTemplateSynchronizationObj.reviseQty_change)
                    .simulate('change');

            $('revise_update_qty_max_applied_value_mode')
                    .observe('change', OttoTemplateSynchronizationObj.reviseQtyMaxAppliedValueMode_change)
                    .simulate('change');

            //stop
            $('stop_mode').observe('change', OttoTemplateSynchronizationObj.stopMode_change)
                    .simulate('change');

            $('stop_qty_calculated')
                    .observe('change', OttoTemplateSynchronizationObj.stopQtyChange)
                    .simulate('change');

            $('stop_advanced_rules_mode')
                    .observe('change', OttoTemplateSynchronizationObj.stopAdvancedRules_change)
                    .simulate('change');
        },
        ...
        listMode_change: function () {
            var rulesContainer = $('magento_block_otto_template_synchronization_form_data_list_rules'),
                    advancedRulesContainer = $('magento_block_otto_template_synchronization_list_advanced_filters');
        ...
        listQtyChange: function () {
            ...
            if (this.value == Otto.php.constant('M2E_Otto_Model_Template_Synchronization::QTY_MODE_YES')) {
                valueContainer.show();
            }
        },
        ...
        reviseQtyMaxAppliedValueMode_change: function (event) {
            var self = OttoTemplateSynchronizationObj;
        ...
        relistMode_change: function () {
            var rulesContainer = $('magento_block_otto_template_synchronization_form_data_relist_rules'),
                    advancedRulesContainer = $('magento_block_otto_template_synchronization_relist_advanced_filters'),
        ...
        relistQtyChange: function (event) {
            OttoTemplateSynchronizationObj.qtyChange(event, this, 'relist');
        },

        // ---------------------------------------

        stopQtyChange: function (event) {
            OttoTemplateSynchronizationObj.qtyChange(event, this, 'stop');
        },

        // ---------------------------------------

        stopMode_change: function () {
            var rulesContainer = $('magento_block_otto_template_synchronization_stop_rules'),
                    advancedRulesContainer = $('magento_block_otto_template_synchronization_stop_advanced_filters');
        ...
        qtyChange: function (event, element, action) {
            ...
            if (element.value == Otto.php.constant('M2E_Otto_Model_Template_Synchronization::QTY_MODE_YES')) {
                qtyCalculatedValue.show();
            } else if (!event.cancelable) {
                OttoTemplateSynchronizationObj.openQtyCalculatedConfirmationPopUp(element, action);
            }
        },
