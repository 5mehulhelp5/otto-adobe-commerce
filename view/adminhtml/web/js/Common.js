define([
    ...
    window.Common = Class.create({
        ...
        initCommonValidators: function () {
            var self = this;
            jQuery.validator.addMethod('Otto-required-when-visible', function (value, el) {
            ...
            jQuery.validator.addMethod('Otto-required-when-visible-and-enabled', function (value, el) {
            ...
            jQuery.validator.addMethod('Otto-validation-float', function (value, element) {
            ...
            }, Otto.translator.translate('Invalid input data. Decimal value required. Example 12.05'));

            jQuery.validator.addMethod('Otto-store-switcher-validation', function (value, element) {
                if (!element.visible()) {
                    return true;
                }
                ...
                return true;
            }, Otto.translator.translate('You should select Store View'));

            jQuery.validator.addMethod('Otto-validate-email', function (value, el) {
                this.error = Validation.get('validate-email').error;
                return Validation.get('validate-email').test(value, el);
            }, Otto.translator.translate('Email is not valid.'));
        },
        ...
        saveClick: function (url, skipValidation) {
            ...
            if (typeof url == 'undefined' || url == '') {
                url = Otto.url.get('formSubmit', {'back': base64_encode('list')});
            }
            this.submitForm(url);
        },
        ...
        saveAndEditClick: function (url, tabsId, skipValidation) {
            ...
            if (typeof url == 'undefined' || url == '') {
                ...
                url = Otto.url.get('formSubmit', {'back': base64_encode('edit' + tabsUrl)});
            }
            this.submitForm(url);
        },
        ...
        duplicateClick: function ($headId, chapter_when_duplicate_text) {
            ...
            Otto.url.add({'formSubmit': Otto.url.get('formSubmitNew')});
            ...
            $$('.otto_duplicate_button').each(function (o) {
                o.hide();
            });
            $$('.otto_delete_button').each(function (o) {
                o.hide();
            });
        ...
        setValidationCheckRepetitionValue: function (idInput, textError, model, dataField, idField, idValue, filterField, filterValue) {
            ...
            jQuery.validator.addMethod(
                    idInput, function (value) {
                        ...
                        new Ajax.Request(Otto.url.get('general/validationCheckRepetitionValue'), {
                            method: 'post',
                            asynchronous: false,
                            parameters: {
                                model: model,
