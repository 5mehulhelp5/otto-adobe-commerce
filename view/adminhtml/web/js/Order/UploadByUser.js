define([
    ...
    window.UploadByUser = Class.create(Common, {
        ...
        openPopup: function () {
            new Ajax.Request(Otto.url.get('order_uploadByUser/getPopupHtml'), {
                method: 'post',
                parameters: {},
                onSuccess: function (transport) {
                    ...
                    var popup = jQuery(modalBlock).modal({
                        title: Otto.translator.translate('Order Reimport'),
                        type: 'popup',
        ...
        resetUpload: function (accountId) {
            new Ajax.Request(Otto.url.get('order_uploadByUser/reset'), {
                method: 'post',
                parameters: {
                ...
                onSuccess: function (transport) {
                    ...
                    if (json.result) {
                        this.messageManager.addSuccess(Otto.translator.translate('Order importing is canceled.'));
                    }
                }.bind(this)
            });
        },
        ...
        configureUpload: function (accountId) {
            ...
            new Ajax.Request(Otto.url.get('order_uploadByUser/configure'), {
                method: 'post',
                parameters: {
                    account_id: accountId,
                ...
                onSuccess: function (transport) {
                    ...
                    if (json.result) {
                        this.messageManager.addSuccess(Otto.translator.translate('Order importing in progress.'));
                    }
                }.bind(this)
            });
        },
