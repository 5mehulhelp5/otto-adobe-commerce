define([
    ...
    window.OrderNote = Class.create(Grid, {
        ...
        openAddNotePopup: function (orderId) {
            new Ajax.Request(Otto.url.get('order/getNotePopupHtml'), {
                method: 'post',
                parameters: {
                    order_id: orderId
                },
        ...
        openPopup: function (content) {
            ...
            var popup = jQuery(modalDialogMessage).modal({
                title: Otto.translator.translate('Custom Note'),
        ...
        saveNote: function () {
            ...
            new Ajax.Request(Otto.url.get('order/saveNote'), {
                method: 'post',
        ...
        deleteNote: function (noteId) {
            ...
            new Ajax.Request(Otto.url.get('order/deleteNote'), {
                method: 'post',
                parameters: {
                    note_id: noteId
                },
