define([
    ...
    window.SettingsLogClearing = Class.create(Common, {
        ...
        initialize: function () {
            jQuery.validator.addMethod('Otto-logs-clearing-interval', function (value, el) {

                if (jQuery.validator.methods['Otto-required-when-visible'](null, el)) {
                    return true;
                }
                ...
                return true;
            }, Otto.translator.translate('logs_clearing_keep_for_days_validation_message'));
        },
            ...
            self.confirm({
                actions: {
                    confirm: function () {
                        ...
                        SettingsObj.submitTab(Otto.url.get('formSubmit', {
                            'task': 'clear_all',
                            'log': log
                        }), formData);
                    },
