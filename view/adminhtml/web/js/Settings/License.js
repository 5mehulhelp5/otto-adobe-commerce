define([
    ...
    window.License = Class.create(Common, {
        ...
        changeLicenseKeyPopup: function () {
            ...
            new Ajax.Request(Otto.url.get('settings_license/change'), {
                method: 'get',
                asynchronous: true,
                onSuccess: function (transport) {

                    var content = transport.responseText;
                    var title = Otto.translator.translate('Use Existing License');
        ...
        completeStep: function () {
            ...
            new Ajax.Request(Otto.url.get('adminhtml_configuration_license/checkLicense'), {
                method: 'get',
                asynchronous: true,
                onSuccess: function (transport) {
                    ...
                    if (checkResult) {
                        ...
                        MessageObj.addError(Otto.translator.translate('You must get valid Trial or Live License Key.'));
                    }
                }
            });
        },
        ...
        refreshStatus: function () {
            var self = this;
            new Ajax.Request(Otto.url.get('settings_license/refreshStatus'), {
                method: 'post',
                asynchronous: true,
                onSuccess: self.processOnSuccess
            });
        ...
        reloadLicenseTab: function () {
            ...
            new Ajax.Request(Otto.url.get('settings_license/section'), {
                method: 'get',
                asynchronous: true,
                onSuccess: function (transport) {
