define([
    ...
    window.TemplateHelperPriceChange = Class.create(Common, {
        ...
        constAbsoluteIncrease: Otto.php.constant(
                '\\M2E\\Otto\\Model\\Template\\SellingFormat::PRICE_MODIFIER_ABSOLUTE_INCREASE'
        ),
        constAbsoluteDecrease: Otto.php.constant(
                '\\M2E\\Otto\\Model\\Template\\SellingFormat::PRICE_MODIFIER_ABSOLUTE_DECREASE'
        ),
        constPercentageIncrease: Otto.php.constant(
                '\\M2E\\Otto\\Model\\Template\\SellingFormat::PRICE_MODIFIER_PERCENTAGE_INCREASE'
        ),
        constPercentageDecrease: Otto.php.constant(
                '\\M2E\\Otto\\Model\\Template\\SellingFormat::PRICE_MODIFIER_PERCENTAGE_DECREASE'
        ),
        constAttribute: Otto.php.constant(
                '\\M2E\\Otto\\Model\\Template\\SellingFormat::PRICE_MODIFIER_ATTRIBUTE'
        ),
