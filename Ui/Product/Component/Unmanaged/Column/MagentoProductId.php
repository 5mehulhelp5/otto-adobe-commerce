        ...
        foreach ($dataSource['data']['items'] as &$row) {
            ...
            if ($magentoProductId === null) {
                $link = sprintf(
                    ...
                    (int)$row['id'],
                    $productTitle,
                    $this->urlBuilder->getUrl('m2e_otto/product_unmanaged_mapping/mapProductPopupHtml', ['account_id' => (int)$row['account_id']]),
                    __('Link')
                );
                ...
                $move = sprintf(
                    ...
                    (int)$row['id'],
                    (int)$row['id'],
                    $this->urlBuilder->getUrl('m2e_otto/product_unmanaged_moving/prepareMoveToListing'),
                    $this->urlBuilder->getUrl('m2e_otto/product_unmanaged_moving/MoveToListingGrid'),
                    $this->urlBuilder->getUrl('m2e_otto/otto_listing_create/index'),
                    __('Move')
                );
                $html .= <<<HTML
