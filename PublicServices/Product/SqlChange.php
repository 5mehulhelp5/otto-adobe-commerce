...
/*
    ...
    $model = $this->_objectManager->create('\M2E\Otto\PublicServices\Product\SqlChange');

    // notify M2E Otto about some change of product with ID 17
    $model->markProductChanged(17);

    // make price change of product with ID 18 and then notify M2E Otto
    $model->markPriceWasChanged(18);

    // make QTY change of product with ID 19 and then notify M2E Otto
    $model->markQtyWasChanged(19);

    // make status change of product with ID 20 and then notify M2E Otto
    $model->markStatusWasChanged(20);

    $model->applyChanges();
*/

namespace M2E\Otto\PublicServices\Product;

use M2E\Otto\Model\ResourceModel\Instruction as InstructionResource;
...
class SqlChange
{
    ...
    private InstructionResource $listingProductInstructionResource;
    ...
    public function __construct(
        ...
        InstructionResource $listingProductInstructionResource,
    ...
    /**
     * @return \M2E\Otto\PublicServices\Product\SqlChange
    ...
    public function markProductAttributeChanged(
        ...
        throw new \M2E\Otto\Model\Exception\Logic('Method is not supported.');
    }
    ...
    protected function filterExistedInstructions(array $instructionsData): array
    {
        ...
        $stmt = $connection
            ...
            ->from(
                ...
                [
                    'listing_product_id' => InstructionResource::COLUMN_LISTING_PRODUCT_ID,
                    'type' => InstructionResource::COLUMN_TYPE
                ]
            )
            ->query();
