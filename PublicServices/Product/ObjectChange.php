...
/*
    ...
    $model = $this->_objectManager->create('\M2E\Otto\PublicServices\Product\ObjectChange');
...
class ObjectChange
{
    ...
    /** @var \M2E\Otto\Observer\Product\AddUpdate\BeforeFactory */
    private $observerProductSaveBeforeFactory;
    /** @var \M2E\Otto\Observer\Product\AddUpdate\AfterFactory */
    private $observerProductSaveAfterFactory;
    /** @var \M2E\Otto\Observer\StockItem\Save\BeforeFactory */
    private $observerStockItemSaveBeforeFactory;
    /** @var \M2E\Otto\Observer\StockItem\Save\AfterFactory */
    ...
    public function __construct(
        ...
        \M2E\Otto\Observer\Product\AddUpdate\BeforeFactory $observerProductSaveBeforeFactory,
        \M2E\Otto\Observer\Product\AddUpdate\AfterFactory $observerProductSaveAfterFactory,
