...
namespace M2E\Otto\Plugin\Config\Magento\Config\Model\Config\Structure;

use M2E\Otto\Helper\View\Configuration;

class Data extends \M2E\Otto\Plugin\AbstractPlugin
{
    ...
    protected function processGet($interceptor, \Closure $callback, array $arguments)
    {
        ...
        if (
            ...
            unset($result['sections']['payment']['children']['ottopayment']);
            unset($result['sections']['carriers']['children']['ottoshipping']);
