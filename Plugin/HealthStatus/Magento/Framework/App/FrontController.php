...
namespace M2E\Otto\Plugin\HealthStatus\Magento\Framework\App;

use Magento\Framework\Message\MessageInterface;
use M2E\Otto\Model\HealthStatus\Task\Result;

class FrontController extends \M2E\Otto\Plugin\AbstractPlugin
{
    public const MESSAGE_IDENTIFIER = 'otto_health_status_front_controller_message';

    /** @var \Magento\Framework\Message\ManagerInterface */
    private $messageManager;
    private \M2E\Otto\Model\HealthStatus\CurrentStatus $healthStatusCurrentStatus;
    private \M2E\Otto\Model\HealthStatus\Notification\MessageBuilder $notificationMessageBuilder;
    ...
    public function __construct(
        ...
        \M2E\Otto\Model\HealthStatus\Notification\Settings $notificationSettings
    ) {
