...
{
    public const BEFORE_EVENT_KEY = 'm2e_otto_before_event_key';

    private \M2E\Otto\Observer\Product\AddUpdate\Before\ProxyFactory $proxyFactory;
    private \M2E\Otto\Model\Magento\Product\ChangeAttributeTrackerFactory $changeAttributeTrackerFactory;
    private ?\M2E\Otto\Observer\Product\AddUpdate\Before\Proxy $proxy = null;
    ...
    private function getProxy(): \M2E\Otto\Observer\Product\AddUpdate\Before\Proxy
    {
        if ($this->proxy !== null) {
            return $this->proxy;
        }
