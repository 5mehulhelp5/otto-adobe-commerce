...
abstract class AbstractProduct extends \M2E\Otto\Observer\AbstractObserver
{
    ...
    public function beforeProcess(): void
    {
        ...
        if (!($product instanceof \Magento\Catalog\Model\Product)) {
            throw new \M2E\Otto\Model\Exception('Product event doesn\'t have correct Product instance.');
        }
