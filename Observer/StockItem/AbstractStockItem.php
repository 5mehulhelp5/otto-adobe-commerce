...
namespace M2E\Otto\Observer\StockItem;

abstract class AbstractStockItem extends \M2E\Otto\Observer\AbstractObserver
{
    ...
    public function beforeProcess(): void
    {
        ...
        if (!($stockItem instanceof \Magento\CatalogInventory\Api\Data\StockItemInterface)) {
            throw new \M2E\Otto\Model\Exception('StockItem event doesn\'t have correct StockItem instance.');
        }
    ...
    protected function getStockItem(): \Magento\CatalogInventory\Api\Data\StockItemInterface
    {
        ...
        if (!isset($this->stockItem)) {
            throw new \M2E\Otto\Model\Exception\Logic('Property "StockItem" should be set first.');
        }
