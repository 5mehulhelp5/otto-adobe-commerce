...
class RecurringData implements InstallDataInterface
{
    ...
    private \M2E\Otto\Model\Setup\InstallChecker $installChecker;
    private \M2E\Otto\Model\Setup\Installer $installer;
    private \M2E\Otto\Model\Setup\Upgrader $upgrader;
    ...
    public function __construct(
        ...
        \M2E\Otto\Model\Setup\InstallChecker $installChecker,
        \M2E\Otto\Model\Setup\Installer $installer,
        \M2E\Otto\Model\Setup\Upgrader $upgrader
    ) {
    ...
    {
        $message = sprintf(
            'Magento version %s is not compatible with M2E Otto version %s.',
            $magentoVersion,
            $moduleVersion
        );

        $message .= ' Please upgrade your Magento first or install an older M2E Otto version 1.35.0';
